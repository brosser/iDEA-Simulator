...
sha_transform ()
  ...
  for (i = 0; i < 20; ++i)
  bc:	00c03821 	addu	a3,a2,zero
  c0:	01201021 	addu	v0,t1,zero
  c4:	00603021 	addu	a2,v1,zero
    {
      FUNC (1, i);
  c8:	01004821 	addu	t1,t0,zero
  cc:	00801821 	addu	v1,a0,zero
...
sha_transform ()
 ...
 124:	3694eba1 	ori	s4,s4,0xeba1
  ...
  for (i = 20; i < 40; ++i)
 128:	00603021 	addu	a2,v1,zero
 12c:	01004821 	addu	t1,t0,zero
 130:	00801821 	addu	v1,a0,zero
    {
      FUNC (2, i);
 134:	02204021 	addu	t0,s1,zero
 138:	00402021 	addu	a0,v0,zero
...
sha_transform ()
 ...
 190:	3694bcdc 	ori	s4,s4,0xbcdc
  ...
  for (i = 40; i < 60; ++i)
 194:	0080a821 	addu	s5,a0,zero
 198:	00e04021 	addu	t0,a3,zero
 19c:	00402021 	addu	a0,v0,zero
    {
      FUNC (3, i);
 1a0:	01203821 	addu	a3,t1,zero
 1a4:	00601021 	addu	v0,v1,zero
...
sha_transform ()
 ...
 200:	3652c1d6 	ori	s2,s2,0xc1d6
  ...
  for (i = 60; i < 80; ++i)
 204:	00402021 	addu	a0,v0,zero
 208:	01003821 	addu	a3,t0,zero
 20c:	00601021 	addu	v0,v1,zero
    {
      FUNC (4, i);
 210:	01604021 	addu	t0,t3,zero
 214:	00c01821 	addu	v1,a2,zero
...
sha_update (const BYTE * buffer, int count)
{
 ...
 3c0:	00a08821 	addu	s1,a1,zero
  if ((sha_info_count_lo + ((LONG) count << 3)) < sha_info_count_lo)
 3c4:	14400028 	bnez	v0,468 <sha_update+0xd4>
 3c8:	00809021 	addu	s2,a0,zero
...
sha_update (const BYTE * buffer, int count)
 ...
 440:	02402821 	addu	a1,s2,zero
 444:	02203021 	addu	a2,s1,zero
}
...
sha_final ()
{
 ...
 4a8:	24070080 	addiu	a3,zero,128
  if (count > 56)
 ...
 4c8:	00831823 	subu	v1,a0,v1
{
 ...
 4d0:	02002021 	addu	a0,s0,zero
  uc = c;
  p = (unsigned long *) s;
  while (e-- > 0)
 4d4:	2405ffff 	addiu	a1,zero,-1
  ...
  for (j = 0; j < VSIZE; j++)
    {
      ...
      p = &indata[j][0];
      sha_update (p, i);
 5ec:	24052000 	addiu	a1,zero,8192
}
 ...
 5f0:	afbf0014 	sw	ra,20(sp)
{
 ...
 60c:	24052000 	addiu	a1,zero,8192
    }
  sha_final ();
}
...
main ()
{
 ...
 630:	00008021 	addu	s0,zero,zero
