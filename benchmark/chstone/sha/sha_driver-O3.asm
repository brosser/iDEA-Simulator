...
static void
sha_transform ()
  ac:	24040010 	addiu	a0,zero,16
  b0:	08000034 	j	d0 <sha_transform+0xd0>
  b4:	2411004f 	addiu	s1,zero,79
  b8:	03001821 	addu	v1,t8,zero
  bc:	03205821 	addu	t3,t9,zero
  c0:	02006021 	addu	t4,s0,zero
  c4:	0100c021 	addu	t8,t0,zero
  c8:	0120c821 	addu	t9,t1,zero
  cc:	01408021 	addu	s0,t2,zero
    {
      W[i] = sha_info_data[i];
    }
  for (i = 16; i < 80; ++i)
...
sha_transform ()
 ...
 19c:	26737999 	addiu	s3,s3,31129
  ...
  for (i = 0; i < 20; ++i)
 1a0:	00c03821 	addu	a3,a2,zero
 1a4:	01201021 	addu	v0,t1,zero
 1a8:	00603021 	addu	a2,v1,zero
    {
      FUNC (1, i);
 1ac:	01004821 	addu	t1,t0,zero
 1b0:	00801821 	addu	v1,a0,zero
...
sha_transform ()
 ...
 208:	3694eba1 	ori	s4,s4,0xeba1
  ...
  for (i = 20; i < 40; ++i)
 20c:	00603021 	addu	a2,v1,zero
 210:	01004821 	addu	t1,t0,zero
 214:	00801821 	addu	v1,a0,zero
    {
      FUNC (2, i);
 218:	02004021 	addu	t0,s0,zero
 21c:	00402021 	addu	a0,v0,zero
...
sha_transform ()
 ...
 274:	3694bcdc 	ori	s4,s4,0xbcdc
  ...
  for (i = 40; i < 60; ++i)
 278:	0080a821 	addu	s5,a0,zero
 27c:	00e04021 	addu	t0,a3,zero
 280:	00402021 	addu	a0,v0,zero
    {
      FUNC (3, i);
 284:	01203821 	addu	a3,t1,zero
 288:	00601021 	addu	v0,v1,zero
...
sha_transform ()
 ...
 2e4:	3652c1d6 	ori	s2,s2,0xc1d6
  ...
  for (i = 60; i < 80; ++i)
 2e8:	00402021 	addu	a0,v0,zero
 2ec:	01003821 	addu	a3,t0,zero
 2f0:	00601021 	addu	v0,v1,zero
    {
      FUNC (4, i);
 2f4:	03204021 	addu	t0,t9,zero
 2f8:	00c01821 	addu	v1,a2,zero
...
sha_update (const BYTE * buffer, int count)
{
 ...
 4a8:	00a08021 	addu	s0,a1,zero
  if ((sha_info_count_lo + ((LONG) count << 3)) < sha_info_count_lo)
 4ac:	144000e9 	bnez	v0,854 <sha_update+0x3dc>
 4b0:	0080a821 	addu	s5,a0,zero
 ...
 4c0:	2a040040 	slti	a0,s0,64
{
 ...
 4d4:	02009821 	addu	s3,s0,zero
 4d8:	02a08821 	addu	s1,s5,zero
...
sha_final ()
{
 ...
 898:	24070080 	addiu	a3,zero,128
  if (count > 56)
 ...
 8b8:	00831823 	subu	v1,a0,v1
{
 ...
 8c0:	02002021 	addu	a0,s0,zero
  uc = c;
  p = (unsigned long *) s;
  while (e-- > 0)
 8c4:	2405ffff 	addiu	a1,zero,-1
 ...
 a0c:	26100000 	addiu	s0,s0,0
{
 ...
 a30:	24052000 	addiu	a1,zero,8192
{
  int count;
  LONG lo_bit_count;
  LONG hi_bit_count;
 ...
 a54:	24070080 	addiu	a3,zero,128
  if (count > 56)
 ...
 a6c:	00831823 	subu	v1,a0,v1
{
 ...
 a74:	02002021 	addu	a0,s0,zero
  uc = c;
  p = (unsigned long *) s;
  while (e-- > 0)
 a78:	2405ffff 	addiu	a1,zero,-1
 ...
 bcc:	02402021 	addu	a0,s2,zero
{
  ...
  for (j = 0; j < VSIZE; j++)
    {
      ...
      p = &indata[j][0];
      sha_update (p, i);
 bd4:	24052000 	addiu	a1,zero,8192
  sha_info_digest[0] = 0x67452301L;
  sha_info_digest[1] = 0xefcdab89L;
  sha_info_digest[2] = 0x98badcfeL;
  sha_info_digest[3] = 0x10325476L;
 ...
 bec:	24052000 	addiu	a1,zero,8192
{
  int count;
  LONG lo_bit_count;
  LONG hi_bit_count;
 ...
 c10:	24070080 	addiu	a3,zero,128
  if (count > 56)
