...
pgetc ()
{
  ...
  if ((temp = *CurHuffReadBuf++) == MARKER_MARKER)
      10:	24640001 	addiu	a0,v1,1
      14:	90620000 	lbu	v0,0(v1)
      18:	af840000 	sw	a0,0(gp)
      1c:	240400ff 	addiu	a0,zero,255
      20:	10440005 	beq	v0,a0,38 <pgetc+0x38>
      ...
      34:	27bd0018 	addiu	sp,sp,24
{
  ...
  if ((temp = *CurHuffReadBuf++) == MARKER_MARKER)
    {				/* If MARKER then */
      ...
      38:	90700001 	lbu	s0,1(v1)
      3c:	24630002 	addiu	v1,v1,2
      40:	1200fff9 	beqz	s0,28 <pgetc+0x28>
      44:	af830000 	sw	v1,0(gp)
	{			/* if next is not 0xff, then marker */
	  printf ("Unanticipated marker detected.\n");
      48:	3c040000 	lui	a0,0x0
      4c:	0c000000 	jal	0 <pgetc>
...
{
  return *ReadBuf++;
      68:	8f830014 	lw	v1,20(gp)
      6c:	00000000 	sll	zero,zero,0x0
      70:	90620000 	lbu	v0,0(v1)
      74:	24630001 	addiu	v1,v1,1
}
      78:	03e00008 	jr	ra
      7c:	af830014 	sw	v1,20(gp)
...
read_word (void)
{
  ...
  c = *ReadBuf++ << 8;
      80:	8f830014 	lw	v1,20(gp)
      84:	00000000 	sll	zero,zero,0x0
      88:	80620000 	lb	v0,0(v1)
  c |= *ReadBuf++;
      8c:	90640001 	lbu	a0,1(v1)
short
read_word (void)
{
  short c;
  ...
  c = *ReadBuf++ << 8;
      90:	00021200 	sll	v0,v0,0x8
  c |= *ReadBuf++;
      94:	24630002 	addiu	v1,v1,2
      98:	af830014 	sw	v1,20(gp)

  return c;
}
      9c:	03e00008 	jr	ra
      a0:	00441025 	or	v0,v0,a0
...
read_byte (void)
{
  return *ReadBuf++;
      ...
      b4:	24440002 	addiu	a0,v0,2
      b8:	90450001 	lbu	a1,1(v0)
{
  int c1, c2;
  c1 = read_byte ();
  c2 = read_byte ();
  ...
  if (c1 != 0xFF || c2 != M_SOI)
      bc:	240200ff 	addiu	v0,zero,255
      c0:	14620008 	bne	v1,v0,e4 <first_marker+0x40>
      c4:	af840014 	sw	a0,20(gp)
      c8:	240200d8 	addiu	v0,zero,216
      cc:	14a20005 	bne	a1,v0,e4 <first_marker+0x40>
  ...
  if (c1 != 0xFF || c2 != M_SOI)
    {
      ...
      f4:	0c000000 	jal	0 <pgetc>
      f8:	af820000 	sw	v0,0(gp)
      EXIT;
      fc:	0c000000 	jal	0 <pgetc>
     100:	00002021 	addu	a0,zero,zero
  ...
  for (;;)
    {
      ...
      while (c != 0xff)
     108:	240400ff 	addiu	a0,zero,255
 *  Read from Buffer
 */
int
read_byte (void)
  ...
  for (;;)
    {
      ...
      while (c != 0xff)
     114:	1444fffd 	bne	v0,a0,10c <next_marker+0x8>
...
read_byte (void)
{
  return *ReadBuf++;
      ...
      do
	{
      ...
      while (c == 0xff);
     124:	1044fffd 	beq	v0,a0,11c <next_marker+0x18>
     128:	24630001 	addiu	v1,v1,1
      if (c != 0)
     12c:	1040fff7 	beqz	v0,10c <next_marker+0x8>
...
get_sof ()
{
     ...
     148:	afbe0030 	sw	s8,48(sp)
     14c:	afb7002c 	sw	s7,44(sp)
     150:	afb60028 	sw	s6,40(sp)
     154:	afb50024 	sw	s5,36(sp)
     158:	afb40020 	sw	s4,32(sp)
     15c:	afb3001c 	sw	s3,28(sp)
     160:	afb20018 	sw	s2,24(sp)
     164:	afb10014 	sw	s1,20(sp)
     168:	afb00010 	sw	s0,16(sp)
 *  Read from Buffer
 */
int
read_byte (void)
...
read_word (void)
{
  ...
  c = *ReadBuf++ << 8;
     17c:	80620003 	lb	v0,3(v1)
  c |= *ReadBuf++;
     180:	90650004 	lbu	a1,4(v1)
short
read_word (void)
{
  short c;
  ...
  c = *ReadBuf++ << 8;
     184:	00021200 	sll	v0,v0,0x8
  c |= *ReadBuf++;
     188:	00451025 	or	v0,v0,a1
  char *p_comp_info_v_samp_factor;
  char *p_comp_info_quant_tbl_no;
...
read_word (void)
{
  ...
  c = *ReadBuf++ << 8;
     190:	80620005 	lb	v0,5(v1)
  c |= *ReadBuf++;
     194:	90650006 	lbu	a1,6(v1)
short
read_word (void)
{
  short c;
...
read_byte (void)
{
  ...
  if (p_jinfo_data_precision != out_data_precision_get_sof)
     22c:	83830000 	lb	v1,0(gp)
     230:	8f820000 	lw	v0,0(gp)
     234:	00000000 	sll	zero,zero,0x0
     238:	10620005 	beq	v1,v0,250 <get_sof+0x114>
     23c:	00000000 	sll	zero,zero,0x0
    {
        main_result++;
     240:	8f820000 	lw	v0,0(gp)
     244:	00000000 	sll	zero,zero,0x0
     248:	24420001 	addiu	v0,v0,1
     24c:	af820000 	sw	v0,0(gp)
    }
  if (p_jinfo_image_height != out_p_jinfo_image_height_get_sof)
     250:	87830000 	lh	v1,0(gp)
     254:	8f820000 	lw	v0,0(gp)
     258:	00000000 	sll	zero,zero,0x0
     25c:	10620005 	beq	v1,v0,274 <get_sof+0x138>
  ...
  for (ci = 0; ci < p_jinfo_num_components; ci++)
     2bc:	1840006c 	blez	v0,470 <get_sof+0x334>
     2c0:	3c1e0000 	lui	s8,0x0
  ...
  /* Check components */
  for (ci = 0; ci < p_jinfo_num_components; ci++)
     2c8:	27960000 	addiu	s6,gp,0
     2cc:	27950000 	addiu	s5,gp,0
     2d0:	27940000 	addiu	s4,gp,0
     2d4:	27930000 	addiu	s3,gp,0
     2d8:	27920000 	addiu	s2,gp,0
     2dc:	00008021 	addu	s0,zero,zero
     2e0:	00008821 	addu	s1,zero,zero
      ...
      *p_comp_info_quant_tbl_no = read_byte ();
      ...
      printf (" id            = %d\n", *p_comp_info_id);
      printf (" h_samp_factor = %d\n", *p_comp_info_h_samp_factor);
     2e4:	27de0000 	addiu	s8,s8,0
      printf (" v_samp_factor = %d\n", *p_comp_info_v_samp_factor);
     2e8:	26f70000 	addiu	s7,s7,0
 *  Read from Buffer
 */
int
read_byte (void)
...
{
  return *ReadBuf++;
     2f4:	90440000 	lbu	a0,0(v0)
     2f8:	24430003 	addiu	v1,v0,3
      p_comp_info_h_samp_factor = &p_jinfo_comps_info_h_samp_factor[ci];
      p_comp_info_v_samp_factor = &p_jinfo_comps_info_v_samp_factor[ci];
      p_comp_info_quant_tbl_no = &p_jinfo_comps_info_quant_tbl_no[ci];
...
read_byte (void)
{
  return *ReadBuf++;
      ...
      *p_comp_info_id = read_byte ();
      c = read_byte ();
      *p_comp_info_h_samp_factor = (c >> 4) & 15;
     308:	00043102 	srl	a2,a0,0x4
      *p_comp_info_v_samp_factor = (c) & 15;
     30c:	3084000f 	andi	a0,a0,0xf
      p_comp_info_quant_tbl_no = &p_jinfo_comps_info_quant_tbl_no[ci];
      ...
      *p_comp_info_id = read_byte ();
      c = read_byte ();
      *p_comp_info_h_samp_factor = (c >> 4) & 15;
     310:	a2860000 	sb	a2,0(s4)
      *p_comp_info_v_samp_factor = (c) & 15;
     314:	a2640000 	sb	a0,0(s3)
 *  Read from Buffer
 */
int
read_byte (void)
...
read_byte (void)
{
  return *ReadBuf++;
      ...
      *p_comp_info_quant_tbl_no = read_byte ();
      ...
      printf (" index         = %d\n", *p_comp_info_index);
     328:	0c000000 	jal	0 <pgetc>
     32c:	a2420000 	sb	v0,0(s2)
      printf (" id            = %d\n", *p_comp_info_id);
     330:	82a50000 	lb	a1,0(s5)
     334:	3c040000 	lui	a0,0x0
     338:	0c000000 	jal	0 <pgetc>
     33c:	24840000 	addiu	a0,a0,0
      printf (" h_samp_factor = %d\n", *p_comp_info_h_samp_factor);
     340:	82850000 	lb	a1,0(s4)
     344:	0c000000 	jal	0 <pgetc>
     348:	03c02021 	addu	a0,s8,zero
      printf (" v_samp_factor = %d\n", *p_comp_info_v_samp_factor);
     34c:	82650000 	lb	a1,0(s3)
     350:	0c000000 	jal	0 <pgetc>
     354:	02e02021 	addu	a0,s7,zero
      printf (" quant_tbl_no  = %d\n\n", *p_comp_info_quant_tbl_no);
     358:	3c040000 	lui	a0,0x0
     35c:	82450000 	lb	a1,0(s2)
     360:	0c000000 	jal	0 <pgetc>
...
get_sof ()
     ...
     36c:	24630000 	addiu	v1,v1,0
     370:	00701021 	addu	v0,v1,s0
      printf (" id            = %d\n", *p_comp_info_id);
      printf (" h_samp_factor = %d\n", *p_comp_info_h_samp_factor);
      printf (" v_samp_factor = %d\n", *p_comp_info_v_samp_factor);
      printf (" quant_tbl_no  = %d\n\n", *p_comp_info_quant_tbl_no);
     ...
     378:	82c30000 	lb	v1,0(s6)
     37c:	00000000 	sll	zero,zero,0x0
     380:	10620005 	beq	v1,v0,398 <get_sof+0x25c>
     384:	3c030000 	lui	v1,0x0
	{
		main_result++;
     388:	8f820000 	lw	v0,0(gp)
     38c:	00000000 	sll	zero,zero,0x0
     390:	24420001 	addiu	v0,v0,1
     394:	af820000 	sw	v0,0(gp)
...
void
get_sof ()
     398:	24630000 	addiu	v1,v1,0
     39c:	00701021 	addu	v0,v1,s0
      ...
      if (*p_comp_info_index != out_index_get_sof[ci])
	{
     ...
     3a4:	82a30000 	lb	v1,0(s5)
     3a8:	00000000 	sll	zero,zero,0x0
     3ac:	10620005 	beq	v1,v0,3c4 <get_sof+0x288>
     3b0:	3c030000 	lui	v1,0x0
	{
		main_result++;
...
void
get_sof ()
     3c4:	24630000 	addiu	v1,v1,0
     3c8:	00701021 	addu	v0,v1,s0
	}
      if (*p_comp_info_id != out_id_get_sof[ci])
	{
		main_result++;
     ...
     3d0:	82830000 	lb	v1,0(s4)
     3d4:	00000000 	sll	zero,zero,0x0
     3d8:	10620005 	beq	v1,v0,3f0 <get_sof+0x2b4>
     3dc:	3c030000 	lui	v1,0x0
	{
		main_result++;
     3e0:	8f820000 	lw	v0,0(gp)
     3e4:	00000000 	sll	zero,zero,0x0
     3e8:	24420001 	addiu	v0,v0,1
     3ec:	af820000 	sw	v0,0(gp)
...
void
get_sof ()
     3f0:	24630000 	addiu	v1,v1,0
     3f4:	00701021 	addu	v0,v1,s0
	}
      if (*p_comp_info_h_samp_factor != out_h_samp_factor_get_sof[ci])
	{
		main_result++;
     ...
     3fc:	82630000 	lb	v1,0(s3)
     400:	00000000 	sll	zero,zero,0x0
     404:	10620005 	beq	v1,v0,41c <get_sof+0x2e0>
...
void
get_sof ()
     41c:	24630000 	addiu	v1,v1,0
     420:	00701021 	addu	v0,v1,s0
	}
      if (*p_comp_info_v_samp_factor != out_v_samp_factor_get_sof[ci])
	{
		main_result++;
     ...
     424:	8c420000 	lw	v0,0(v0)
     428:	82430000 	lb	v1,0(s2)
     42c:	00000000 	sll	zero,zero,0x0
     430:	10620005 	beq	v1,v0,448 <get_sof+0x30c>
     434:	00000000 	sll	zero,zero,0x0
	{
		main_result++;
     438:	8f820000 	lw	v0,0(gp)
     43c:	00000000 	sll	zero,zero,0x0
     440:	24420001 	addiu	v0,v0,1
     444:	af820000 	sw	v0,0(gp)
  length -= 8;
  ...
  /* Check components */
  for (ci = 0; ci < p_jinfo_num_components; ci++)
     448:	83820000 	lb	v0,0(gp)
     44c:	26310001 	addiu	s1,s1,1
     450:	0222102a 	slt	v0,s1,v0
     454:	26d60001 	addiu	s6,s6,1
     458:	26b50001 	addiu	s5,s5,1
     45c:	26940001 	addiu	s4,s4,1
     460:	26730001 	addiu	s3,s3,1
     464:	26520001 	addiu	s2,s2,1
     468:	1440ffa0 	bnez	v0,2ec <get_sof+0x1b0>
     46c:	26100004 	addiu	s0,s0,4
  ...
  if (p_jinfo_comps_info_h_samp_factor[0] == 2)
     470:	83820000 	lb	v0,0(gp)
     474:	24030002 	addiu	v1,zero,2
     478:	1043000f 	beq	v0,v1,4b8 <get_sof+0x37c>
    ...
    {
      p_jinfo_smp_fact = SF1_1_1;
     484:	af800000 	sw	zero,0(gp)
      printf ("\nSampling Factor is 1:1:1\n");
    }
}
     488:	8fbf0034 	lw	ra,52(sp)
     48c:	8fbe0030 	lw	s8,48(sp)
     490:	8fb7002c 	lw	s7,44(sp)
     494:	8fb60028 	lw	s6,40(sp)
     498:	8fb50024 	lw	s5,36(sp)
     49c:	8fb40020 	lw	s4,32(sp)
     4a0:	8fb3001c 	lw	s3,28(sp)
     4a4:	8fb20018 	lw	s2,24(sp)
     4a8:	8fb10014 	lw	s1,20(sp)
     4ac:	8fb00010 	lw	s0,16(sp)
      printf ("\nSampling Factor is 4:1:1\n");
    }
  else
    {
      p_jinfo_smp_fact = SF1_1_1;
      printf ("\nSampling Factor is 1:1:1\n");
     4b0:	08000000 	j	0 <pgetc>
     4b4:	27bd0038 	addiu	sp,sp,56
   *  Only 1_1_1 and 4_1_1 are supported
   */
  if (p_jinfo_comps_info_h_samp_factor[0] == 2)
    {
  ...
  if (p_jinfo_comps_info_h_samp_factor[0] == 2)
    {
      p_jinfo_smp_fact = SF4_1_1;
     4c0:	08000122 	j	488 <get_sof+0x34c>
     4c4:	af820000 	sw	v0,0(gp)
...
get_sos ()
{
     4d0:	afbf0034 	sw	ra,52(sp)
     4d4:	afbe0030 	sw	s8,48(sp)
     4d8:	afb7002c 	sw	s7,44(sp)
     4dc:	afb60028 	sw	s6,40(sp)
     4e0:	afb50024 	sw	s5,36(sp)
     4e4:	afb40020 	sw	s4,32(sp)
     4e8:	afb3001c 	sw	s3,28(sp)
     4ec:	afb20018 	sw	s2,24(sp)
     4f0:	afb10014 	sw	s1,20(sp)
     4f4:	afb00010 	sw	s0,16(sp)
short
read_word (void)
{
  short c;
  ...
  c = *ReadBuf++ << 8;
     4f8:	80500000 	lb	s0,0(v0)
  c |= *ReadBuf++;
     4fc:	90430001 	lbu	v1,1(v0)
short
read_word (void)
{
  short c;
...
read_byte (void)
{
  ...
  for (i = 0; i < num_comp; i++)
     574:	13c00055 	beqz	s8,6cc <get_sos+0x204>
     578:	00009821 	addu	s3,zero,zero
    }
}
...
get_sos ()
    ...
    id_found:
     ...
     580:	27970000 	addiu	s7,gp,0
      *p_comp_info_ac_tbl_no = (c) & 15;
     584:	27960000 	addiu	s6,gp,0
 *  Read from Buffer
 */
int
read_byte (void)
...
{
  return *ReadBuf++;
     590:	24430002 	addiu	v1,v0,2
     594:	90510000 	lbu	s1,0(v0)
     598:	90420001 	lbu	v0,1(v0)
  for (i = 0; i < num_comp; i++)
    {
      cc = read_byte ();
      c = read_byte ();
      ...
      for (ci = 0; ci < p_jinfo_num_components; ci++)
     59c:	18a0005d 	blez	a1,714 <get_sos+0x24c>
     5a0:	af830014 	sw	v1,20(gp)
	{
	  p_comp_info_id = &p_jinfo_comps_info_id[ci];
     ...
     5a4:	83830000 	lb	v1,0(gp)
     5a8:	00000000 	sll	zero,zero,0x0
     5ac:	10710057 	beq	v1,s1,70c <get_sos+0x244>
     5b0:	00001821 	addu	v1,zero,zero
  for (i = 0; i < num_comp; i++)
    {
      cc = read_byte ();
      c = read_byte ();
      ...
      for (ci = 0; ci < p_jinfo_num_components; ci++)
     5b4:	24630001 	addiu	v1,v1,1
     5b8:	0065202a 	slt	a0,v1,a1
     5bc:	10800055 	beqz	a0,714 <get_sos+0x24c>
...
get_sos ()
     5c4:	02432021 	addu	a0,s2,v1
	{
	  ...
	  if (cc == *p_comp_info_id)
     5c8:	80840000 	lb	a0,0(a0)
     5cc:	00000000 	sll	zero,zero,0x0
     5d0:	1491fff8 	bne	a0,s1,5b4 <get_sos+0xec>
     5d4:	00608021 	addu	s0,v1,zero
      main_result++;
      printf ("Bad Component ID!\n");
      EXIT;
    ...
    id_found:
      *p_comp_info_dc_tbl_no = (c >> 4) & 15;
     5d8:	00021902 	srl	v1,v0,0x4
     5dc:	02f0a821 	addu	s5,s7,s0
      *p_comp_info_ac_tbl_no = (c) & 15;
     5e0:	02d0a021 	addu	s4,s6,s0
     5e4:	3042000f 	andi	v0,v0,0xf

      printf (" comp_id       = %d\n", cc);
     5e8:	3c040000 	lui	a0,0x0
      main_result++;
      printf ("Bad Component ID!\n");
      EXIT;
    ...
    id_found:
      *p_comp_info_dc_tbl_no = (c >> 4) & 15;
     5ec:	a2a30000 	sb	v1,0(s5)
      *p_comp_info_ac_tbl_no = (c) & 15;

      printf (" comp_id       = %d\n", cc);
     5f0:	02202821 	addu	a1,s1,zero
     5f4:	24840000 	addiu	a0,a0,0
     5f8:	0c000000 	jal	0 <pgetc>
     5fc:	a2820000 	sb	v0,0(s4)
      printf (" dc_tbl_no     = %d\n", *p_comp_info_dc_tbl_no);
     600:	82a50000 	lb	a1,0(s5)
     604:	3c040000 	lui	a0,0x0
     608:	0c000000 	jal	0 <pgetc>
     60c:	24840000 	addiu	a0,a0,0
      printf (" ac_tbl_no     = %d\n", *p_comp_info_ac_tbl_no);
     610:	82850000 	lb	a1,0(s4)
     614:	3c040000 	lui	a0,0x0
     618:	0c000000 	jal	0 <pgetc>
     61c:	24840000 	addiu	a0,a0,0

      if (cc != out_comp_id_get_sos[i_get_sos])
     620:	8f830000 	lw	v1,0(gp)
     624:	3c050000 	lui	a1,0x0
     628:	00031080 	sll	v0,v1,0x2
     62c:	24a50000 	addiu	a1,a1,0
     630:	00a22021 	addu	a0,a1,v0
     634:	8c840000 	lw	a0,0(a0)
     638:	00000000 	sll	zero,zero,0x0
     63c:	10910005 	beq	a0,s1,654 <get_sos+0x18c>
     640:	3c060000 	lui	a2,0x0
	{
		main_result++;
     644:	8f840000 	lw	a0,0(gp)
     648:	00000000 	sll	zero,zero,0x0
     64c:	24840001 	addiu	a0,a0,1
     650:	af840000 	sw	a0,0(gp)
	}
      if (*p_comp_info_dc_tbl_no != out_dc_tbl_no_get_sos[i_get_sos])
     654:	24c60000 	addiu	a2,a2,0
     658:	02f02821 	addu	a1,s7,s0
     65c:	00c22021 	addu	a0,a2,v0
     660:	80a50000 	lb	a1,0(a1)
     664:	8c840000 	lw	a0,0(a0)
     668:	00000000 	sll	zero,zero,0x0
     66c:	10a40006 	beq	a1,a0,688 <get_sos+0x1c0>
     670:	3c040000 	lui	a0,0x0
	{
		main_result++;
     674:	8f840000 	lw	a0,0(gp)
     678:	00000000 	sll	zero,zero,0x0
     67c:	24840001 	addiu	a0,a0,1
     680:	af840000 	sw	a0,0(gp)
	}
      if (*p_comp_info_ac_tbl_no != out_ac_tbl_no_get_sos[i_get_sos])
     684:	3c040000 	lui	a0,0x0
     688:	24840000 	addiu	a0,a0,0
     68c:	00821021 	addu	v0,a0,v0
     690:	02d08021 	addu	s0,s6,s0
     694:	82040000 	lb	a0,0(s0)
     698:	8c420000 	lw	v0,0(v0)
     69c:	00000000 	sll	zero,zero,0x0
     6a0:	10820005 	beq	a0,v0,6b8 <get_sos+0x1f0>
     6a4:	00000000 	sll	zero,zero,0x0
	{
		main_result++;
     6a8:	8f820000 	lw	v0,0(gp)
     6ac:	00000000 	sll	zero,zero,0x0
     6b0:	24420001 	addiu	v0,v0,1
     6b4:	af820000 	sw	v0,0(gp)
    {
        main_result++;
    }
  ...
  /* Decode each component */
  for (i = 0; i < num_comp; i++)
     6c0:	027e102a 	slt	v0,s3,s8
     6c4:	1440ffb0 	bnez	v0,588 <get_sos+0xc0>
     6c8:	af830000 	sw	v1,0(gp)
 *  Read from Buffer
 */
int
read_byte (void)
...
read_byte (void)
{
   ...
   */
  p_jinfo_jpeg_data = ReadBuf;
     700:	af820000 	sw	v0,0(gp)

}
     704:	03e00008 	jr	ra
     708:	27bd0038 	addiu	sp,sp,56
      cc = read_byte ();
      c = read_byte ();
	...
	{
	  p_comp_info_id = &p_jinfo_comps_info_id[ci];
     70c:	08000176 	j	5d8 <get_sos+0x110>
     ...
     724:	0c000000 	jal	0 <pgetc>
     728:	af820000 	sw	v0,0(gp)
      EXIT;
     72c:	0c000000 	jal	0 <pgetc>
     730:	00002021 	addu	a0,zero,zero
...
get_dht ()
{
     ...
     740:	afbe0030 	sw	s8,48(sp)
     744:	afb7002c 	sw	s7,44(sp)
     748:	afb60028 	sw	s6,40(sp)
     74c:	afb50024 	sw	s5,36(sp)
     750:	afb40020 	sw	s4,32(sp)
     754:	afb3001c 	sw	s3,28(sp)
     758:	afb20018 	sw	s2,24(sp)
     75c:	afb10014 	sw	s1,20(sp)
     760:	afb00010 	sw	s0,16(sp)
short
read_word (void)
{
  short c;
  ...
  c = *ReadBuf++ << 8;
     764:	80520000 	lb	s2,0(v0)
  c |= *ReadBuf++;
     768:	90430001 	lbu	v1,1(v0)
short
read_word (void)
{
  short c;
  ...
  c = *ReadBuf++ << 8;
     76c:	00129200 	sll	s2,s2,0x8
  c |= *ReadBuf++;
     770:	02439025 	or	s2,s2,v1
  int index, i, count;
  int *p_xhtbl_bits;
  int *p_xhtbl_huffval;
...
read_word (void)
{
  ...
  printf (" length = %d\n", length);
     780:	24840000 	addiu	a0,a0,0
     784:	02402821 	addu	a1,s2,zero
     788:	0c000000 	jal	0 <pgetc>
     78c:	af820014 	sw	v0,20(gp)

  if (length != out_length_get_dht[i_get_dht])
     790:	8f830000 	lw	v1,0(gp)
     794:	3c020000 	lui	v0,0x0
     798:	00031880 	sll	v1,v1,0x2
     79c:	24420000 	addiu	v0,v0,0
     7a0:	00621021 	addu	v0,v1,v0
     7a4:	8c420000 	lw	v0,0(v0)
     7a8:	00000000 	sll	zero,zero,0x0
     7ac:	10520006 	beq	v0,s2,7c8 <get_dht+0x94>
     7b0:	2a420011 	slti	v0,s2,17
    {
        main_result++;
     7b4:	8f820000 	lw	v0,0(gp)
     7b8:	00000000 	sll	zero,zero,0x0
     7bc:	24420001 	addiu	v0,v0,1
     7c0:	af820000 	sw	v0,0(gp)
    }

  while (length > 16)
     7c4:	2a420011 	slti	v0,s2,17
     7c8:	1440005a 	bnez	v0,934 <get_dht+0x200>
     7cc:	3c1e0000 	lui	s8,0x0
     7d0:	3c170000 	lui	s7,0x0
    {
      index = read_byte ();

      printf (" index = 0x%x\n", index);
     7d4:	3c160000 	lui	s6,0x0
	{
      ...
      printf (" count = %d\n", count);
     7d8:	3c150000 	lui	s5,0x0
     7dc:	27de0000 	addiu	s8,s8,0
     7e0:	26f70000 	addiu	s7,s7,0
...
{
  return *ReadBuf++;
     7fc:	90500000 	lbu	s0,0(v0)
     800:	24420001 	addiu	v0,v0,1
  ...
  while (length > 16)
    {
      ...
      printf (" index = 0x%x\n", index);
     804:	02002821 	addu	a1,s0,zero
     808:	0c000000 	jal	0 <pgetc>
     80c:	af820014 	sw	v0,20(gp)

      if (index != out_index_get_dht[i_get_dht])
     810:	8f820000 	lw	v0,0(gp)
     814:	00000000 	sll	zero,zero,0x0
     818:	00021080 	sll	v0,v0,0x2
     81c:	03c21021 	addu	v0,s8,v0
     820:	8c420000 	lw	v0,0(v0)
     824:	00000000 	sll	zero,zero,0x0
     828:	10500006 	beq	v0,s0,844 <get_dht+0x110>
     82c:	32020010 	andi	v0,s0,0x10
	{
        main_result++;
     830:	8f820000 	lw	v0,0(gp)
     834:	00000000 	sll	zero,zero,0x0
     838:	24420001 	addiu	v0,v0,1
     83c:	af820000 	sw	v0,0(gp)
}

      if (index & 0x10)
     840:	32020010 	andi	v0,s0,0x10
     844:	10400047 	beqz	v0,964 <get_dht+0x230>
     848:	001011c0 	sll	v0,s0,0x7
	{
	  /* AC */
	  index -= 0x10;
     84c:	2610fff0 	addiu	s0,s0,-16
	  p_xhtbl_bits = p_jinfo_ac_xhuff_tbl_bits[index];
     850:	001011c0 	sll	v0,s0,0x7
     854:	00102100 	sll	a0,s0,0x4
     858:	00822021 	addu	a0,a0,v0
     85c:	3c020000 	lui	v0,0x0
     860:	24420000 	addiu	v0,v0,0
	  p_xhtbl_huffval = p_jinfo_ac_xhuff_tbl_huffval[index];
     864:	00109880 	sll	s3,s0,0x2
      ...
      if (index & 0x10)
	{
	  ...
	  index -= 0x10;
	  p_xhtbl_bits = p_jinfo_ac_xhuff_tbl_bits[index];
     868:	00442021 	addu	a0,v0,a0
	  p_xhtbl_huffval = p_jinfo_ac_xhuff_tbl_huffval[index];
     86c:	00108280 	sll	s0,s0,0xa
     870:	3c020000 	lui	v0,0x0
     874:	02709821 	addu	s3,s3,s0
     878:	24420000 	addiu	v0,v0,0
     87c:	00539821 	addu	s3,v0,s3
	}
      else
	{
	  /* DC */
	  ...
	  p_xhtbl_huffval = p_jinfo_dc_xhuff_tbl_huffval[index];
     880:	8f820014 	lw	v0,20(gp)
	}

      count = 0;
     884:	00008021 	addu	s0,zero,zero

      for (i = 1; i <= 16; i++)
     888:	24030001 	addiu	v1,zero,1
...
read_byte (void)
{
  return *ReadBuf++;
     890:	90a5ffff 	lbu	a1,-1(a1)
      ...
      for (i = 1; i <= 16; i++)
     894:	24630001 	addiu	v1,v1,1
	{
	  p_xhtbl_bits[i] = read_byte ();
     898:	ac850004 	sw	a1,4(a0)
	  count += p_xhtbl_bits[i];
     89c:	02058021 	addu	s0,s0,a1
	  p_xhtbl_huffval = p_jinfo_dc_xhuff_tbl_huffval[index];
	}
      ...
      for (i = 1; i <= 16; i++)
     8a0:	1471fffa 	bne	v1,s1,88c <get_dht+0x158>
     8a4:	24840004 	addiu	a0,a0,4
     8a8:	24420010 	addiu	v0,v0,16
	{
	  p_xhtbl_bits[i] = read_byte ();
	  count += p_xhtbl_bits[i];
	}
      ...
      printf (" count = %d\n", count);
     8ac:	02a02021 	addu	a0,s5,zero
     8b0:	02002821 	addu	a1,s0,zero
     8b4:	0c000000 	jal	0 <pgetc>
     8b8:	af820014 	sw	v0,20(gp)

      if (count != out_count_get_dht[i_get_dht])
     8bc:	8f820000 	lw	v0,0(gp)
     8c0:	00000000 	sll	zero,zero,0x0
     8c4:	00021880 	sll	v1,v0,0x2
     8c8:	02e31821 	addu	v1,s7,v1
     8cc:	8c630000 	lw	v1,0(v1)
     8d0:	00000000 	sll	zero,zero,0x0
     8d4:	10700005 	beq	v1,s0,8ec <get_dht+0x1b8>
     8d8:	00000000 	sll	zero,zero,0x0
	{
        main_result++;
     8dc:	8f830000 	lw	v1,0(gp)
     8e0:	00000000 	sll	zero,zero,0x0
     8e4:	24630001 	addiu	v1,v1,1
     8e8:	af830000 	sw	v1,0(gp)
    }
      i_get_dht++;
     8ec:	24420001 	addiu	v0,v0,1
      ...
      for (i = 0; i < count; i++)
     8f0:	1200000b 	beqz	s0,920 <get_dht+0x1ec>
     8f4:	af820000 	sw	v0,0(gp)
     8f8:	8f840014 	lw	a0,20(gp)
     8fc:	00001021 	addu	v0,zero,zero
...
read_byte (void)
{
  return *ReadBuf++;
     90c:	ae630000 	sw	v1,0(s3)
      ...
      for (i = 0; i < count; i++)
     910:	1450fffb 	bne	v0,s0,900 <get_dht+0x1cc>
     914:	26730004 	addiu	s3,s3,4
     918:	00902021 	addu	a0,a0,s0
     91c:	af840014 	sw	a0,20(gp)
	{
        main_result++;
    }
      i_get_dht++;
  ...
  while (length > 16)
     928:	2a420011 	slti	v0,s2,17
     92c:	1040ffb1 	beqz	v0,7f4 <get_dht+0xc0>
     ...
     934:	8fbf0034 	lw	ra,52(sp)
     938:	8fbe0030 	lw	s8,48(sp)
     93c:	8fb7002c 	lw	s7,44(sp)
     940:	8fb60028 	lw	s6,40(sp)
     944:	8fb50024 	lw	s5,36(sp)
     948:	8fb40020 	lw	s4,32(sp)
     94c:	8fb3001c 	lw	s3,28(sp)
     950:	8fb20018 	lw	s2,24(sp)
     954:	8fb10014 	lw	s1,20(sp)
     958:	8fb00010 	lw	s0,16(sp)
     95c:	03e00008 	jr	ra
     960:	27bd0038 	addiu	sp,sp,56
	  p_xhtbl_huffval = p_jinfo_ac_xhuff_tbl_huffval[index];
	}
      else
	{
	  /* DC */
	  p_xhtbl_bits = p_jinfo_dc_xhuff_tbl_bits[index];
     964:	00102100 	sll	a0,s0,0x4
     968:	00822021 	addu	a0,a0,v0
     96c:	3c020000 	lui	v0,0x0
     970:	24420000 	addiu	v0,v0,0
	  p_xhtbl_huffval = p_jinfo_dc_xhuff_tbl_huffval[index];
     974:	00109880 	sll	s3,s0,0x2
	  p_xhtbl_huffval = p_jinfo_ac_xhuff_tbl_huffval[index];
	}
      else
	{
	  /* DC */
	  p_xhtbl_bits = p_jinfo_dc_xhuff_tbl_bits[index];
     978:	00442021 	addu	a0,v0,a0
	  p_xhtbl_huffval = p_jinfo_dc_xhuff_tbl_huffval[index];
     97c:	00108280 	sll	s0,s0,0xa
     980:	3c020000 	lui	v0,0x0
     984:	02709821 	addu	s3,s3,s0
     988:	24420000 	addiu	v0,v0,0
     98c:	08000220 	j	880 <get_dht+0x14c>
     990:	00539821 	addu	s3,v0,s3
...
get_dqt ()
{
     99c:	afbf0034 	sw	ra,52(sp)
     9a0:	afbe0030 	sw	s8,48(sp)
     9a4:	afb7002c 	sw	s7,44(sp)
     9a8:	afb60028 	sw	s6,40(sp)
     9ac:	afb50024 	sw	s5,36(sp)
     9b0:	afb40020 	sw	s4,32(sp)
     9b4:	afb3001c 	sw	s3,28(sp)
     9b8:	afb20018 	sw	s2,24(sp)
     9bc:	afb10014 	sw	s1,20(sp)
     9c0:	afb00010 	sw	s0,16(sp)
short
read_word (void)
{
  short c;
  ...
  c = *ReadBuf++ << 8;
     9c4:	80520000 	lb	s2,0(v0)
  c |= *ReadBuf++;
     9c8:	90430001 	lbu	v1,1(v0)
short
read_word (void)
{
  short c;
  ...
  c = *ReadBuf++ << 8;
     9cc:	00129200 	sll	s2,s2,0x8
  c |= *ReadBuf++;
     9d0:	02439025 	or	s2,s2,v1
  int prec, num, i;
  unsigned int tmp;
...
read_word (void)
{
  ...
  printf (" length = %d\n", length);
     ...
     9e4:	02402821 	addu	a1,s2,zero
     9e8:	0c000000 	jal	0 <pgetc>
     9ec:	af820014 	sw	v0,20(gp)

  if (length != out_length_get_dqt[i_get_dqt])
     9f0:	8f820000 	lw	v0,0(gp)
     9f4:	27830000 	addiu	v1,gp,0
     9f8:	00021080 	sll	v0,v0,0x2
     9fc:	00621021 	addu	v0,v1,v0
     a00:	8c420000 	lw	v0,0(v0)
     a04:	00000000 	sll	zero,zero,0x0
     a08:	10520005 	beq	v0,s2,a20 <get_dqt+0x8c>
     a0c:	00000000 	sll	zero,zero,0x0
    {
        main_result++;
     a10:	8f820000 	lw	v0,0(gp)
     a14:	00000000 	sll	zero,zero,0x0
     a18:	24420001 	addiu	v0,v0,1
     a1c:	af820000 	sw	v0,0(gp)
    }

  while (length > 0)
     a20:	1a400052 	blez	s2,b6c <get_dqt+0x1d8>
     a24:	3c160000 	lui	s6,0x0
      ...
      printf (" prec = %d\n", prec);
     a28:	3c150000 	lui	s5,0x0
      printf (" num  = %d\n", num);
     a2c:	3c140000 	lui	s4,0x0
    }
}
...
void
get_dqt ()
     a30:	3c110000 	lui	s1,0x0
     a34:	279e0000 	addiu	s8,gp,0
     a38:	27970000 	addiu	s7,gp,0
     a3c:	26d60000 	addiu	s6,s6,0
      /* Precision 0:8bit, 1:16bit */
      prec = num >> 4;
      /* Table Number */
      num &= 0x0f;
      ...
      printf (" prec = %d\n", prec);
     a40:	26b50000 	addiu	s5,s5,0
      printf (" num  = %d\n", num);
     a44:	26940000 	addiu	s4,s4,0
    }
}
  ...
  while (length > 0)
    {
      ...
      /* Precision 0:8bit, 1:16bit */
      prec = num >> 4;
     a5c:	00138103 	sra	s0,s3,0x4
      /* Table Number */
      num &= 0x0f;

      printf (" prec = %d\n", prec);
     a60:	02002821 	addu	a1,s0,zero
    {
      num = read_byte ();
      /* Precision 0:8bit, 1:16bit */
      prec = num >> 4;
      /* Table Number */
      num &= 0x0f;
     a64:	3273000f 	andi	s3,s3,0xf

      printf (" prec = %d\n", prec);
     a68:	0c000000 	jal	0 <pgetc>
     a6c:	af820014 	sw	v0,20(gp)
      printf (" num  = %d\n", num);
     a70:	02802021 	addu	a0,s4,zero
     a74:	0c000000 	jal	0 <pgetc>
     a78:	02602821 	addu	a1,s3,zero

      if (prec != out_prec_get_dht[i_get_dqt])
     a7c:	8f820000 	lw	v0,0(gp)
     a80:	00000000 	sll	zero,zero,0x0
     a84:	00021880 	sll	v1,v0,0x2
     a88:	03c32021 	addu	a0,s8,v1
     a8c:	8c840000 	lw	a0,0(a0)
     a90:	00000000 	sll	zero,zero,0x0
     a94:	10900005 	beq	a0,s0,aac <get_dqt+0x118>
     a98:	00000000 	sll	zero,zero,0x0
	{
        main_result++;
     a9c:	8f840000 	lw	a0,0(gp)
     aa0:	00000000 	sll	zero,zero,0x0
     aa4:	24840001 	addiu	a0,a0,1
     aa8:	af840000 	sw	a0,0(gp)
    }
      if (num != out_num_get_dht[i_get_dqt])
     aac:	02e31821 	addu	v1,s7,v1
     ab0:	8c630000 	lw	v1,0(v1)
     ab4:	00000000 	sll	zero,zero,0x0
     ab8:	10730005 	beq	v1,s3,ad0 <get_dqt+0x13c>
     abc:	00000000 	sll	zero,zero,0x0
	{
        main_result++;
     ac0:	8f830000 	lw	v1,0(gp)
     ac4:	00000000 	sll	zero,zero,0x0
     ac8:	24630001 	addiu	v1,v1,1
     acc:	af830000 	sw	v1,0(gp)
    }
      i_get_dqt++;
     ad0:	24430001 	addiu	v1,v0,1

      p_quant_tbl = &p_jinfo_quant_tbl_quantval[num][DCTSIZE2];
     ad4:	26660001 	addiu	a2,s3,1
    }
      if (num != out_num_get_dht[i_get_dqt])
	{
        main_result++;
      ...
      i_get_dqt++;
     ad8:	af830000 	sw	v1,0(gp)

      p_quant_tbl = &p_jinfo_quant_tbl_quantval[num][DCTSIZE2];
     adc:	3c030000 	lui	v1,0x0
     ae0:	24630000 	addiu	v1,v1,0
     ae4:	00063200 	sll	a2,a2,0x8
     ae8:	00663021 	addu	a2,v1,a2
     aec:	8f820014 	lw	v0,20(gp)
     af0:	080002ca 	j	b28 <get_dqt+0x194>
     af4:	02c01821 	addu	v1,s6,zero
short
read_word (void)
{
  short c;
  ...
  c = *ReadBuf++ << 8;
     af8:	80450000 	lb	a1,0(v0)
  c |= *ReadBuf++;
     afc:	90840000 	lbu	a0,0(a0)
short
read_word (void)
{
  short c;
  ...
  c = *ReadBuf++ << 8;
      ...
      for (i = 0; i < DCTSIZE2; i++)
	{
	  if (prec)
	    tmp = read_word ();
     b04:	00a42825 	or	a1,a1,a0
	  else
	    tmp = read_byte ();
	  p_quant_tbl[izigzag_index[i]] = (unsigned short) tmp;
     b08:	8c640000 	lw	a0,0(v1)
     b0c:	30a5ffff 	andi	a1,a1,0xffff
     b10:	00042080 	sll	a0,a0,0x2
     b14:	00c42021 	addu	a0,a2,a0
     b18:	24630004 	addiu	v1,v1,4
read_word (void)
{
  short c;
  ...
  c |= *ReadBuf++;
     b1c:	24420002 	addiu	v0,v0,2
      ...
      p_quant_tbl = &p_jinfo_quant_tbl_quantval[num][DCTSIZE2];
      for (i = 0; i < DCTSIZE2; i++)
     b20:	1071000c 	beq	v1,s1,b54 <get_dqt+0x1c0>
     b24:	ac850000 	sw	a1,0(a0)
	{
	  if (prec)
     b28:	1600fff3 	bnez	s0,af8 <get_dqt+0x164>
     b2c:	24440001 	addiu	a0,v0,1
	    tmp = read_word ();
	  else
	    tmp = read_byte ();
	  p_quant_tbl[izigzag_index[i]] = (unsigned short) tmp;
     b30:	8c640000 	lw	a0,0(v1)
 *  Read from Buffer
 */
int
read_byte (void)
  ...
  return *ReadBuf++;
     b34:	90450000 	lbu	a1,0(v0)
	{
	  if (prec)
	    ...
	    tmp = read_byte ();
	  p_quant_tbl[izigzag_index[i]] = (unsigned short) tmp;
     b38:	00042080 	sll	a0,a0,0x2
     b3c:	30a5ffff 	andi	a1,a1,0xffff
     b40:	00c42021 	addu	a0,a2,a0
     b44:	24630004 	addiu	v1,v1,4
 *  Read from Buffer
 */
int
read_byte (void)
{
  return *ReadBuf++;
     b48:	24420001 	addiu	v0,v0,1
      ...
      p_quant_tbl = &p_jinfo_quant_tbl_quantval[num][DCTSIZE2];
      for (i = 0; i < DCTSIZE2; i++)
     b4c:	1471fff6 	bne	v1,s1,b28 <get_dqt+0x194>
     b50:	ac850000 	sw	a1,0(a0)
     b54:	af820014 	sw	v0,20(gp)
      ...
      length -= DCTSIZE2 + 1;
      if (prec)
     b58:	12000002 	beqz	s0,b64 <get_dqt+0x1d0>
     b5c:	2652ffbf 	addiu	s2,s2,-65
	length -= DCTSIZE2;
     b60:	2652ffc0 	addiu	s2,s2,-64
  if (length != out_length_get_dqt[i_get_dqt])
    {
        main_result++;
    }
  ...
  while (length > 0)
     b64:	1e40ffb9 	bgtz	s2,a4c <get_dqt+0xb8>
	...
	length -= DCTSIZE2;
     ...
     b6c:	8fbf0034 	lw	ra,52(sp)
     b70:	8fbe0030 	lw	s8,48(sp)
     b74:	8fb7002c 	lw	s7,44(sp)
     b78:	8fb60028 	lw	s6,40(sp)
     b7c:	8fb50024 	lw	s5,36(sp)
     b80:	8fb40020 	lw	s4,32(sp)
     b84:	8fb3001c 	lw	s3,28(sp)
     b88:	8fb20018 	lw	s2,24(sp)
     b8c:	8fb10014 	lw	s1,20(sp)
     b90:	8fb00010 	lw	s0,16(sp)
     b94:	03e00008 	jr	ra
     b98:	27bd0038 	addiu	sp,sp,56

00000b9c <read_markers>:
...
{
     b9c:	27bdffd8 	addiu	sp,sp,-40
     ba0:	afb40020 	sw	s4,32(sp)
     ba4:	afb3001c 	sw	s3,28(sp)
     ba8:	afb20018 	sw	s2,24(sp)
     bac:	3c130000 	lui	s3,0x0
     bb0:	3c140000 	lui	s4,0x0
      else
	{
...
read_markers (unsigned char *buf)
{
     ...
     bbc:	afbf0024 	sw	ra,36(sp)
     bc0:	afb00010 	sw	s0,16(sp)
  int unread_marker;
  int sow_SOI;

  ReadBuf = buf;
     bc4:	af840014 	sw	a0,20(gp)

  sow_SOI = 0;
     bc8:	00008821 	addu	s1,zero,zero
     bcc:	26730000 	addiu	s3,s3,0
     bd0:	26940000 	addiu	s4,s4,0
      else
	{
	  unread_marker = next_marker ();
	}
  ...
  for (;;)
    {
      if (!sow_SOI)
     bd8:	16200031 	bnez	s1,ca0 <read_markers+0x104>
     bdc:	00000000 	sll	zero,zero,0x0
	{
	  unread_marker = first_marker ();
     be0:	0c000000 	jal	0 <pgetc>
     be4:	00000000 	sll	zero,zero,0x0
     be8:	00408021 	addu	s0,v0,zero
      else
	{
	  unread_marker = next_marker ();
	}
      ...
      printf ("\nmarker = 0x%x\n", unread_marker);
     bec:	02402021 	addu	a0,s2,zero
     bf0:	0c000000 	jal	0 <pgetc>
     bf4:	02002821 	addu	a1,s0,zero

      if (unread_marker != out_unread_marker[i_marker++])
     bf8:	8f820000 	lw	v0,0(gp)
     bfc:	00000000 	sll	zero,zero,0x0
     c00:	00021880 	sll	v1,v0,0x2
     c04:	02631821 	addu	v1,s3,v1
     c08:	8c630000 	lw	v1,0(v1)
     c0c:	24420001 	addiu	v0,v0,1
     c10:	12030005 	beq	s0,v1,c28 <read_markers+0x8c>
     c14:	af820000 	sw	v0,0(gp)
	{
		main_result++;
     c18:	8f820000 	lw	v0,0(gp)
     c1c:	00000000 	sll	zero,zero,0x0
     c20:	24420001 	addiu	v0,v0,1
     c24:	af820000 	sw	v0,0(gp)
	}


      switch (unread_marker)
     c28:	2610ff40 	addiu	s0,s0,-192
     c2c:	2e02001c 	sltiu	v0,s0,28
     c30:	1040ffe9 	beqz	v0,bd8 <read_markers+0x3c>
     c34:	00108080 	sll	s0,s0,0x2
     c38:	02908021 	addu	s0,s4,s0
     c3c:	8e020000 	lw	v0,0(s0)
	...
	case M_DQT:
	  get_dqt ();
     c4c:	0c000000 	jal	0 <pgetc>
     c50:	00000000 	sll	zero,zero,0x0
     c54:	080002f6 	j	bd8 <read_markers+0x3c>
	...
	case M_EOI:
     ...
     c60:	8fb40020 	lw	s4,32(sp)
     c64:	8fb3001c 	lw	s3,28(sp)
     c68:	8fb20018 	lw	s2,24(sp)
     c6c:	8fb10014 	lw	s1,20(sp)
     c70:	8fb00010 	lw	s0,16(sp)
	...
	case M_EOI:
     ...
     c80:	8fb40020 	lw	s4,32(sp)
     c84:	8fb3001c 	lw	s3,28(sp)
     c88:	8fb20018 	lw	s2,24(sp)
     c8c:	8fb10014 	lw	s1,20(sp)
     c90:	8fb00010 	lw	s0,16(sp)
     c94:	03e00008 	jr	ra
     c98:	27bd0028 	addiu	sp,sp,40
	...
	{
	  unread_marker = next_marker ();
     ca0:	0c000000 	jal	0 <pgetc>
     ca4:	00000000 	sll	zero,zero,0x0
     ca8:	080002fb 	j	bec <read_markers+0x50>
     cac:	00408021 	addu	s0,v0,zero
	case M_SOI:		/* Start of Image */
	  sow_SOI = 1;
	  break;
	...
	case M_SOF0:		/* Baseline DCT ( Huffman ) */
     ...
     cb4:	00000000 	sll	zero,zero,0x0
	  break;
     cb8:	080002f6 	j	bd8 <read_markers+0x3c>
	...
	case M_DHT:
     ...
     cc4:	00000000 	sll	zero,zero,0x0
	  break;
     cc8:	080002f6 	j	bd8 <read_markers+0x3c>
...
ChenIDct (int *x, int *y)
{
     ...
     cd4:	afbe0024 	sw	s8,36(sp)
     cd8:	afb70020 	sw	s7,32(sp)
     cdc:	afb6001c 	sw	s6,28(sp)
     ce0:	afb50018 	sw	s5,24(sp)
     ce4:	afb40014 	sw	s4,20(sp)
     ce8:	afb30010 	sw	s3,16(sp)
     cec:	afb2000c 	sw	s2,12(sp)
     cf0:	afb10008 	sw	s1,8(sp)
     cf4:	afb00004 	sw	s0,4(sp)
     cf8:	afa5002c 	sw	a1,44(sp)
      *aptr = b0 - c3;
    }
  ...
  for (i = 0; i < 8; i++)
     d00:	00004021 	addu	t0,zero,zero
      aptr += 8;
      a0 = LS (*aptr, 2);
      aptr += 8;
      b2 = LS (*aptr, 2);
      aptr += 8;
      a1 = LS (*aptr, 2);
     d04:	8c870060 	lw	a3,96(a0)
      aptr += 8;
      b1 = LS (*aptr, 2);
      aptr += 8;
      a2 = LS (*aptr, 2);
     d08:	8c8600a0 	lw	a2,160(a0)
  for (i = 0; i < 8; i++)
    {
      aptr = x + i;
      b0 = LS (*aptr, 2);
     ...
     d14:	00076140 	sll	t4,a3,0x5
     d18:	00064a00 	sll	t1,a2,0x8
     d1c:	00075a00 	sll	t3,a3,0x8
     d20:	00065140 	sll	t2,a2,0x5
     d24:	018b5821 	addu	t3,t4,t3
     d28:	01495021 	addu	t2,t2,t1
      aptr += 8;
      a0 = LS (*aptr, 2);
      aptr += 8;
      b2 = LS (*aptr, 2);
      aptr += 8;
      a1 = LS (*aptr, 2);
     d2c:	00073880 	sll	a3,a3,0x2
      aptr += 8;
      b1 = LS (*aptr, 2);
      aptr += 8;
      a2 = LS (*aptr, 2);
     d30:	00063080 	sll	a2,a2,0x2
      ...
      c0 = MSCALE ((c7d16 * a0) - (c1d16 * a3));
     d34:	00036100 	sll	t4,v1,0x4
     d38:	00054900 	sll	t1,a1,0x4
      c1 = MSCALE ((c3d16 * a2) - (c5d16 * a1));
     d3c:	01673823 	subu	a3,t3,a3
     d40:	01463023 	subu	a2,t2,a2
     ...
     d48:	00055280 	sll	t2,a1,0xa
      ...
      c0 = MSCALE ((c7d16 * a0) - (c1d16 * a3));
     d4c:	0005c980 	sll	t9,a1,0x6
      c1 = MSCALE ((c3d16 * a2) - (c5d16 * a1));
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
     d50:	0003c180 	sll	t8,v1,0x6
      ...
      c0 = MSCALE ((c7d16 * a0) - (c1d16 * a3));
     d54:	0139c821 	addu	t9,t1,t9
      c1 = MSCALE ((c3d16 * a2) - (c5d16 * a1));
     d58:	00077880 	sll	t7,a3,0x2
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
     d5c:	0198c021 	addu	t8,t4,t8
     d60:	01494823 	subu	t1,t2,t1
      /* Split into even mode  b0 = x0  b1 = x4  b2 = x2  b3 = x6.
         And the odd terms a0 = x1 a1 = x3 a2 = x5 a3 = x7.
       */
  ...
  for (i = 0; i < 8; i++)
    {
     ...
     d70:	00052880 	sll	a1,a1,0x2
      ...
      c0 = MSCALE ((c7d16 * a0) - (c1d16 * a3));
     d74:	006c5823 	subu	t3,v1,t4
      c1 = MSCALE ((c3d16 * a2) - (c5d16 * a1));
     d78:	01c63023 	subu	a2,t6,a2
      ...
      c0 = MSCALE ((c7d16 * a0) - (c1d16 * a3));
     d7c:	00198880 	sll	s1,t9,0x2
      c1 = MSCALE ((c3d16 * a2) - (c5d16 * a1));
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
     d80:	01e73823 	subu	a3,t7,a3
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
     d84:	00185080 	sll	t2,t8,0x2
     d88:	01252823 	subu	a1,t1,a1
      aptr += 8;
      b2 = LS (*aptr, 2);
      aptr += 8;
      a1 = LS (*aptr, 2);
  ...
  for (i = 0; i < 8; i++)
    {
     ...
     d90:	8c8d0000 	lw	t5,0(a0)
      ...
      c0 = MSCALE ((c7d16 * a0) - (c1d16 * a3));
     d94:	0331c821 	addu	t9,t9,s1
      c1 = MSCALE ((c3d16 * a2) - (c5d16 * a1));
     d98:	00066040 	sll	t4,a2,0x1
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
     d9c:	00073840 	sll	a3,a3,0x1
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
     da0:	030ac021 	addu	t8,t8,t2
     da4:	00052840 	sll	a1,a1,0x1
      ...
      c0 = MSCALE ((c7d16 * a0) - (c1d16 * a3));
     da8:	000b5840 	sll	t3,t3,0x1
      c1 = MSCALE ((c3d16 * a2) - (c5d16 * a1));
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
     dac:	01c77021 	addu	t6,t6,a3
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
     db0:	03055021 	addu	t2,t8,a1
      ...
      c0 = MSCALE ((c7d16 * a0) - (c1d16 * a3));
     db4:	01795821 	addu	t3,t3,t9
      c1 = MSCALE ((c3d16 * a2) - (c5d16 * a1));
     db8:	018f6023 	subu	t4,t4,t7
      aptr += 8;
      b1 = LS (*aptr, 2);
      aptr += 8;
      a2 = LS (*aptr, 2);
  ...
  for (i = 0; i < 8; i++)
    {
     ...
     dc4:	00103080 	sll	a2,s0,0x2
      ...
      c0 = MSCALE ((c7d16 * a0) - (c1d16 * a3));
      c1 = MSCALE ((c3d16 * a2) - (c5d16 * a1));
     dc8:	000c6243 	sra	t4,t4,0x9
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
     dcc:	000e4a43 	sra	t1,t6,0x9
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
     dd0:	000a5243 	sra	t2,t2,0x9
     ...
     de4:	01a63023 	subu	a2,t5,a2
      ...
      a1 = c0 - c1;
      a2 = c3 - c2;
     de8:	01496823 	subu	t5,t2,t1
      a3 = c3 + c2;

      c0 = a0;
      c1 = MSCALE (c1d4 * (a2 - a1));
     dec:	01a32823 	subu	a1,t5,v1
      /* First Butterfly on even terms. */
     ...
     df4:	01a31821 	addu	v1,t5,v1
      ...
      a0 = MSCALE (c1d4 * (b0 + b1));
      a1 = MSCALE (c1d4 * (b0 - b1));
     df8:	00068900 	sll	s1,a2,0x4
     dfc:	00066880 	sll	t5,a2,0x2

      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
     e00:	0018f200 	sll	s8,t8,0x8
     e04:	0019a100 	sll	s4,t9,0x4
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
     ...
     e18:	0003b100 	sll	s6,v1,0x4
      ...
      a0 = MSCALE (c1d4 * (b0 + b1));
     e1c:	00079100 	sll	s2,a3,0x4
      a1 = MSCALE (c1d4 * (b0 - b1));

      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
      a3 = MSCALE ((c1d8 * b2) + (c3d8 * b3));
     e20:	0019aa00 	sll	s5,t9,0x8
      /* First Butterfly on even terms. */
     ...
     e28:	00036880 	sll	t5,v1,0x2
      ...
      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
     e2c:	0019c9c0 	sll	t9,t9,0x7
      a3 = MSCALE ((c1d8 * b2) + (c3d8 * b3));
     e30:	0018c1c0 	sll	t8,t8,0x7
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
     ...
     e38:	0005b900 	sll	s7,a1,0x4
      ...
      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
     e3c:	0334c823 	subu	t9,t9,s4
      a3 = MSCALE ((c1d8 * b2) + (c3d8 * b3));
     e40:	0313c023 	subu	t8,t8,s3
      a2 = c3 - c2;
      a3 = c3 + c2;
     ...
     e4c:	00057080 	sll	t6,a1,0x2
      ...
      a0 = MSCALE (c1d4 * (b0 + b1));
      a1 = MSCALE (c1d4 * (b0 - b1));
     e50:	00119900 	sll	s3,s1,0x4

      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
     e54:	03d0f023 	subu	s8,s8,s0
      a1 = c0 - c1;
      a2 = c3 - c2;
      a3 = c3 + c2;
     ...
     e58:	02ee7023 	subu	t6,s7,t6
      ...
      a0 = MSCALE (c1d4 * (b0 + b1));
     e5c:	0012a100 	sll	s4,s2,0x4
      a1 = MSCALE (c1d4 * (b0 - b1));

      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
      a3 = MSCALE ((c1d8 * b2) + (c3d8 * b3));
     e60:	02afa823 	subu	s5,s5,t7
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
      ...
      a0 = MSCALE (c1d4 * (b0 + b1));
      a1 = MSCALE (c1d4 * (b0 - b1));
     e64:	02718823 	subu	s1,s3,s1

      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
     e68:	001ef0c0 	sll	s8,s8,0x3
     e6c:	0019b8c0 	sll	s7,t9,0x3
      a2 = c3 - c2;
      a3 = c3 + c2;
     ...
     e70:	000d9900 	sll	s3,t5,0x4
      ...
      a0 = MSCALE (c1d4 * (b0 + b1));
     e74:	02929023 	subu	s2,s4,s2
      a1 = MSCALE (c1d4 * (b0 - b1));
     e78:	02268821 	addu	s1,s1,a2
      a2 = c3 - c2;
      a3 = c3 + c2;
     ...
     e7c:	026d6823 	subu	t5,s3,t5
      ...
      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
      a3 = MSCALE ((c1d8 * b2) + (c3d8 * b3));
     e80:	0018b0c0 	sll	s6,t8,0x3
     e84:	0015a8c0 	sll	s5,s5,0x3
      a1 = c0 - c1;
      a2 = c3 - c2;
      a3 = c3 + c2;
     ...
     e88:	000ea100 	sll	s4,t6,0x4
      ...
      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
     e8c:	03d08021 	addu	s0,s8,s0
     e90:	02f9c823 	subu	t9,s7,t9
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
     ...
     e94:	02479021 	addu	s2,s2,a3
      ...
      c0 = a0;
      c1 = MSCALE (c1d4 * (a2 - a1));
     e98:	028e7023 	subu	t6,s4,t6
      c2 = MSCALE (c1d4 * (a2 + a1));
     e9c:	01a31821 	addu	v1,t5,v1
      ...
      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
      a3 = MSCALE ((c1d8 * b2) + (c3d8 * b3));
     ea0:	02d8c023 	subu	t8,s6,t8
     ea4:	02af7821 	addu	t7,s5,t7
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
      ...
      a0 = MSCALE (c1d4 * (b0 + b1));
      a1 = MSCALE (c1d4 * (b0 - b1));
     ea8:	00118840 	sll	s1,s1,0x1

      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
     eac:	0330c823 	subu	t9,t9,s0
      a1 = c0 - c1;
      a2 = c3 - c2;
      a3 = c3 + c2;
     ...
     eb0:	01c52821 	addu	a1,t6,a1
      ...
      a0 = MSCALE (c1d4 * (b0 + b1));
      a1 = MSCALE (c1d4 * (b0 - b1));
     eb4:	00118a43 	sra	s1,s1,0x9

      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
     eb8:	0019ca43 	sra	t9,t9,0x9
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
      ...
      a0 = MSCALE (c1d4 * (b0 + b1));
     ebc:	00129040 	sll	s2,s2,0x1
      a1 = MSCALE (c1d4 * (b0 - b1));

      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
      a3 = MSCALE ((c1d8 * b2) + (c3d8 * b3));
     ec0:	030f7821 	addu	t7,t8,t7
      a2 = c3 - c2;
      a3 = c3 + c2;
     ...
     ec8:	02396821 	addu	t5,s1,t9
      ...
      a0 = MSCALE (c1d4 * (b0 + b1));
     ecc:	00129243 	sra	s2,s2,0x9
      a1 = MSCALE (c1d4 * (b0 - b1));

      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
      a3 = MSCALE ((c1d8 * b2) + (c3d8 * b3));
     ed0:	000f7a43 	sra	t7,t7,0x9
      a2 = c3 - c2;
      a3 = c3 + c2;
     ...
     edc:	01f23021 	addu	a2,t7,s2
      ...
      a0 = c0 + c1;
     ee0:	018b5821 	addu	t3,t4,t3
      a1 = c0 - c1;
      a2 = c3 - c2;
      a3 = c3 + c2;
     ee4:	01494821 	addu	t1,t2,t1
      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
      a3 = MSCALE ((c1d8 * b2) + (c3d8 * b3));
      ...
      b1 = a1 + a2;
      b2 = a1 - a2;
     ee8:	0239c823 	subu	t9,s1,t9
      b3 = a0 - a3;
     eec:	024f9023 	subu	s2,s2,t7
      a1 = c0 - c1;
      a2 = c3 - c2;
      a3 = c3 + c2;
     ...
     ef8:	01a31823 	subu	v1,t5,v1
      ...
      aptr = y + i;
      *aptr = b0 + c3;
     efc:	01267021 	addu	t6,t1,a2
      aptr += 8;
      *aptr = b1 + c2;
      aptr += 8;
      *aptr = b2 + c1;
     f00:	00b95021 	addu	t2,a1,t9
      aptr += 8;
      *aptr = b3 + c0;
     f04:	01723821 	addu	a3,t3,s2
      aptr += 8;
      *aptr = b3 - c0;
      aptr += 8;
      *aptr = b2 - c1;
      ...
      *aptr = b3 + c0;
      aptr += 8;
      *aptr = b3 - c0;
     f0c:	024b5823 	subu	t3,s2,t3
      aptr += 8;
      *aptr = b2 - c1;
     f10:	03252823 	subu	a1,t9,a1
      aptr += 8;
      *aptr = b1 - c2;
      aptr += 8;
      *aptr = b0 - c3;
     f14:	00c94823 	subu	t1,a2,t1
  register int b0, b1, b2, b3;
  register int c0, c1, c2, c3;
  ...
  for (i = 0; i < 8; i++)
     f18:	25080001 	addiu	t0,t0,1
     f1c:	24030008 	addiu	v1,zero,8
      c1 = MSCALE (c1d4 * (a2 - a1));
      c2 = MSCALE (c1d4 * (a2 + a1));
      c3 = a3;
     ...
     f20:	ac4e0000 	sw	t6,0(v0)
      aptr += 8;
      *aptr = b1 + c2;
     f24:	ac4c0020 	sw	t4,32(v0)
      aptr += 8;
      *aptr = b2 + c1;
     f28:	ac4a0040 	sw	t2,64(v0)
      aptr += 8;
      *aptr = b3 + c0;
     f2c:	ac470060 	sw	a3,96(v0)
      aptr += 8;
      *aptr = b3 - c0;
     f30:	ac4b0080 	sw	t3,128(v0)
      aptr += 8;
      *aptr = b2 - c1;
     f34:	ac4500a0 	sw	a1,160(v0)
      aptr += 8;
      *aptr = b1 - c2;
      aptr += 8;
      *aptr = b0 - c3;
     f38:	ac4900e0 	sw	t1,224(v0)
  register int b0, b1, b2, b3;
  register int c0, c1, c2, c3;
  ...
  for (i = 0; i < 8; i++)
     f3c:	24840004 	addiu	a0,a0,4
     f40:	1503ff70 	bne	t0,v1,d04 <ChenIDct+0x34>
     f44:	24420004 	addiu	v0,v0,4
     f48:	00002821 	addu	a1,zero,zero
      *aptr = b0 - c3;
    }
  ...
  for (i = 0; i < 8; i++)
     f4c:	24160008 	addiu	s6,zero,8
    {
      aptr = y + LS (i, 3);
     f50:	8fa3002c 	lw	v1,44(sp)
     f54:	00051140 	sll	v0,a1,0x5
     f58:	00621021 	addu	v0,v1,v0
      b0 = *(aptr++);
      a0 = *(aptr++);
      b2 = *(aptr++);
      a1 = *(aptr++);
     f5c:	8c46000c 	lw	a2,12(v0)
      b1 = *(aptr++);
      a2 = *(aptr++);
     f60:	8c470014 	lw	a3,20(v0)
  ...
  for (i = 0; i < 8; i++)
    {
     ...
     f68:	8c44001c 	lw	a0,28(v0)
      ...
      c0 = MSCALE ((c7d16 * a0) - (c1d16 * a3));
      c1 = MSCALE ((c3d16 * a2) - (c5d16 * a1));
     f6c:	000758c0 	sll	t3,a3,0x3
     f70:	000650c0 	sll	t2,a2,0x3
     f74:	00074980 	sll	t1,a3,0x6
     f78:	00064180 	sll	t0,a2,0x6
     f7c:	01694821 	addu	t1,t3,t1
     f80:	01484021 	addu	t0,t2,t0
      /*
         Split into even mode  b0 = x0  b1 = x4  b2 = x2  b3 = x6.
         And the odd terms a0 = x1 a1 = x3 a2 = x5 a3 = x7.
       */
      ...
      c0 = MSCALE ((c7d16 * a0) - (c1d16 * a3));
     f84:	00046080 	sll	t4,a0,0x2
     f88:	00035080 	sll	t2,v1,0x2
      c1 = MSCALE ((c3d16 * a2) - (c5d16 * a1));
     f8c:	01063023 	subu	a2,t0,a2
      /*
         Split into even mode  b0 = x0  b1 = x4  b2 = x2  b3 = x6.
         And the odd terms a0 = x1 a1 = x3 a2 = x5 a3 = x7.
       */
      ...
      c0 = MSCALE ((c7d16 * a0) - (c1d16 * a3));
     f90:	00046a00 	sll	t5,a0,0x8
      c1 = MSCALE ((c3d16 * a2) - (c5d16 * a1));
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
     f94:	00035a00 	sll	t3,v1,0x8
         Split into even mode  b0 = x0  b1 = x4  b2 = x2  b3 = x6.
         And the odd terms a0 = x1 a1 = x3 a2 = x5 a3 = x7.
       */
     ...
     f98:	01273823 	subu	a3,t1,a3
      ...
      c0 = MSCALE ((c7d16 * a0) - (c1d16 * a3));
     f9c:	00037100 	sll	t6,v1,0x4
      c1 = MSCALE ((c3d16 * a2) - (c5d16 * a1));
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
     fa0:	00044100 	sll	t0,a0,0x4
      /*
         Split into even mode  b0 = x0  b1 = x4  b2 = x2  b3 = x6.
         And the odd terms a0 = x1 a1 = x3 a2 = x5 a3 = x7.
       */
      ...
      c0 = MSCALE ((c7d16 * a0) - (c1d16 * a3));
     fa4:	014e7021 	addu	t6,t2,t6
      c1 = MSCALE ((c3d16 * a2) - (c5d16 * a1));
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
     fa8:	01884021 	addu	t0,t4,t0
     fac:	016a5023 	subu	t2,t3,t2
      /*
         Split into even mode  b0 = x0  b1 = x4  b2 = x2  b3 = x6.
         And the odd terms a0 = x1 a1 = x3 a2 = x5 a3 = x7.
       */
      ...
      c0 = MSCALE ((c7d16 * a0) - (c1d16 * a3));
     fb0:	01ac6023 	subu	t4,t5,t4
      c1 = MSCALE ((c3d16 * a2) - (c5d16 * a1));
     fb4:	00074880 	sll	t1,a3,0x2
     fb8:	00067880 	sll	t7,a2,0x2
      /*
         Split into even mode  b0 = x0  b1 = x4  b2 = x2  b3 = x6.
         And the odd terms a0 = x1 a1 = x3 a2 = x5 a3 = x7.
       */
      ...
      c0 = MSCALE ((c7d16 * a0) - (c1d16 * a3));
     fbc:	008c2023 	subu	a0,a0,t4
     fc0:	000e6880 	sll	t5,t6,0x2
      c1 = MSCALE ((c3d16 * a2) - (c5d16 * a1));
     fc4:	01273823 	subu	a3,t1,a3
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
     fc8:	01e63023 	subu	a2,t7,a2
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
     fcc:	00085880 	sll	t3,t0,0x2
     fd0:	01431823 	subu	v1,t2,v1
      /*
         Split into even mode  b0 = x0  b1 = x4  b2 = x2  b3 = x6.
         And the odd terms a0 = x1 a1 = x3 a2 = x5 a3 = x7.
       */
      ...
      c0 = MSCALE ((c7d16 * a0) - (c1d16 * a3));
     fd4:	00042040 	sll	a0,a0,0x1
     fd8:	01cd6821 	addu	t5,t6,t5
      c1 = MSCALE ((c3d16 * a2) - (c5d16 * a1));
     fdc:	00073840 	sll	a3,a3,0x1
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
     fe0:	00063040 	sll	a2,a2,0x1
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
     fe4:	010b5821 	addu	t3,t0,t3
     fe8:	00031840 	sll	v1,v1,0x1
  /* Loop over rows */
  ...
  for (i = 0; i < 8; i++)
    {
      aptr = y + LS (i, 3);
      b0 = *(aptr++);
     fec:	8c4e0000 	lw	t6,0(v0)
      a0 = *(aptr++);
      b2 = *(aptr++);
      a1 = *(aptr++);
      b1 = *(aptr++);
     ff0:	8c480010 	lw	t0,16(v0)
         Split into even mode  b0 = x0  b1 = x4  b2 = x2  b3 = x6.
         And the odd terms a0 = x1 a1 = x3 a2 = x5 a3 = x7.
       */
      ...
      c0 = MSCALE ((c7d16 * a0) - (c1d16 * a3));
      c1 = MSCALE ((c3d16 * a2) - (c5d16 * a1));
     ff4:	00ef7823 	subu	t7,a3,t7
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
     ff8:	01264821 	addu	t1,t1,a2
      /*
         Split into even mode  b0 = x0  b1 = x4  b2 = x2  b3 = x6.
         And the odd terms a0 = x1 a1 = x3 a2 = x5 a3 = x7.
       */
      ...
      c0 = MSCALE ((c7d16 * a0) - (c1d16 * a3));
     ffc:	008d6821 	addu	t5,a0,t5
      c1 = MSCALE ((c3d16 * a2) - (c5d16 * a1));
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
    1000:	01635821 	addu	t3,t3,v1
      a0 = *(aptr++);
      b2 = *(aptr++);
      a1 = *(aptr++);
      b1 = *(aptr++);
  ...
  for (i = 0; i < 8; i++)
    ...
    1008:	8c430008 	lw	v1,8(v0)
      ...
      c0 = MSCALE ((c7d16 * a0) - (c1d16 * a3));
    100c:	000d6a43 	sra	t5,t5,0x9
      c1 = MSCALE ((c3d16 * a2) - (c5d16 * a1));
    1010:	000f6243 	sra	t4,t7,0x9
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
    1014:	00095243 	sra	t2,t1,0x9
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
    1018:	000b5a43 	sra	t3,t3,0x9

      /* First Butterfly on even terms. */

      a0 = MSCALE (c1d4 * (b0 + b1));
    101c:	010e4821 	addu	t1,t0,t6
      b3 = a0 - a3;
    ...
    1024:	01c84023 	subu	t0,t6,t0
      ...
      a1 = c0 - c1;
      a2 = c3 - c2;
    1028:	016a7023 	subu	t6,t3,t2
      a3 = c3 + c2;

      c0 = a0;
      c1 = MSCALE (c1d4 * (a2 - a1));
    102c:	01c63823 	subu	a3,t6,a2
      /* First Butterfly on even terms. */
    ...
    1038:	0003c880 	sll	t9,v1,0x2
      ...
      a0 = MSCALE (c1d4 * (b0 + b1));
    103c:	00097880 	sll	t7,t1,0x2
      a1 = MSCALE (c1d4 * (b0 - b1));
    1040:	00087080 	sll	t6,t0,0x2
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
      ...
      a0 = MSCALE (c1d4 * (b0 + b1));
    1044:	00098900 	sll	s1,t1,0x4
      a1 = MSCALE (c1d4 * (b0 - b1));
    1048:	00088100 	sll	s0,t0,0x4

      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
    104c:	0004f180 	sll	s8,a0,0x6
      a3 = MSCALE ((c1d8 * b2) + (c3d8 * b3));
    1050:	0003a180 	sll	s4,v1,0x6
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
      ...
      a0 = MSCALE (c1d4 * (b0 + b1));
    1054:	022f8823 	subu	s1,s1,t7
      a1 = MSCALE (c1d4 * (b0 - b1));
    1058:	020e8023 	subu	s0,s0,t6

      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
    105c:	0003b940 	sll	s7,v1,0x5
      a3 = MSCALE ((c1d8 * b2) + (c3d8 * b3));
    1060:	0004a940 	sll	s5,a0,0x5
      a1 = c0 - c1;
      a2 = c3 - c2;
      a3 = c3 + c2;
      ...
      c0 = a0;
      c1 = MSCALE (c1d4 * (a2 - a1));
    1064:	00079900 	sll	s3,a3,0x4
      c2 = MSCALE (c1d4 * (a2 + a1));
    1068:	00069100 	sll	s2,a2,0x4
      /* First Butterfly on even terms. */
      ...
      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
    106c:	03d8f023 	subu	s8,s8,t8
      a3 = MSCALE ((c1d8 * b2) + (c3d8 * b3));
    1070:	0299a023 	subu	s4,s4,t9
      a1 = c0 - c1;
      a2 = c3 - c2;
      a3 = c3 + c2;
      ...
      c0 = a0;
      c1 = MSCALE (c1d4 * (a2 - a1));
    1074:	00077880 	sll	t7,a3,0x2
      c2 = MSCALE (c1d4 * (a2 + a1));
    1078:	00067080 	sll	t6,a2,0x2
      a1 = c0 - c1;
      a2 = c3 - c2;
      a3 = c3 + c2;
      ...
      c0 = a0;
      c1 = MSCALE (c1d4 * (a2 - a1));
    107c:	026f7823 	subu	t7,s3,t7
      c2 = MSCALE (c1d4 * (a2 + a1));
    1080:	024e7023 	subu	t6,s2,t6
      /* First Butterfly on even terms. */
      ...
      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
    1084:	02f9c823 	subu	t9,s7,t9
      a3 = MSCALE ((c1d8 * b2) + (c3d8 * b3));
    1088:	02b8c023 	subu	t8,s5,t8
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
      ...
      a0 = MSCALE (c1d4 * (b0 + b1));
    108c:	00119900 	sll	s3,s1,0x4
      a1 = MSCALE (c1d4 * (b0 - b1));
    1090:	00109100 	sll	s2,s0,0x4

      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
    1094:	03c4f023 	subu	s8,s8,a0
      a3 = MSCALE ((c1d8 * b2) + (c3d8 * b3));
    1098:	0283a023 	subu	s4,s4,v1
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
      ...
      a0 = MSCALE (c1d4 * (b0 + b1));
    109c:	02718823 	subu	s1,s3,s1
      a1 = MSCALE (c1d4 * (b0 - b1));
    10a0:	02508023 	subu	s0,s2,s0

      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
    10a4:	001ef0c0 	sll	s8,s8,0x3
    10a8:	0019b8c0 	sll	s7,t9,0x3
      a3 = MSCALE ((c1d8 * b2) + (c3d8 * b3));
    10ac:	0018a8c0 	sll	s5,t8,0x3
    10b0:	0014a0c0 	sll	s4,s4,0x3
      a1 = c0 - c1;
      a2 = c3 - c2;
      a3 = c3 + c2;
      ...
      c0 = a0;
      c1 = MSCALE (c1d4 * (a2 - a1));
    10b4:	000f9900 	sll	s3,t7,0x4
      c2 = MSCALE (c1d4 * (a2 + a1));
    10b8:	000e9100 	sll	s2,t6,0x4
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
      ...
      a0 = MSCALE (c1d4 * (b0 + b1));
      a1 = MSCALE (c1d4 * (b0 - b1));
    10bc:	02088021 	addu	s0,s0,t0

      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
      a3 = MSCALE ((c1d8 * b2) + (c3d8 * b3));
    10c0:	02831821 	addu	v1,s4,v1
      a1 = c0 - c1;
      a2 = c3 - c2;
      a3 = c3 + c2;
      ...
      c0 = a0;
      c1 = MSCALE (c1d4 * (a2 - a1));
    10c4:	026f7823 	subu	t7,s3,t7
      c2 = MSCALE (c1d4 * (a2 + a1));
    10c8:	024e7023 	subu	t6,s2,t6
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
      ...
      a0 = MSCALE (c1d4 * (b0 + b1));
    10cc:	02294821 	addu	t1,s1,t1
      a1 = MSCALE (c1d4 * (b0 - b1));

      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
    10d0:	03c42021 	addu	a0,s8,a0
    10d4:	02f9c823 	subu	t9,s7,t9
      a3 = MSCALE ((c1d8 * b2) + (c3d8 * b3));
    10d8:	02b8c023 	subu	t8,s5,t8
    10dc:	0303c021 	addu	t8,t8,v1
      a1 = c0 - c1;
      a2 = c3 - c2;
      a3 = c3 + c2;
      ...
      c0 = a0;
      c1 = MSCALE (c1d4 * (a2 - a1));
    10e0:	01e73821 	addu	a3,t7,a3
      c2 = MSCALE (c1d4 * (a2 + a1));
    10e4:	01c63021 	addu	a2,t6,a2
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
      ...
      a0 = MSCALE (c1d4 * (b0 + b1));
    10e8:	00094840 	sll	t1,t1,0x1
      a1 = MSCALE (c1d4 * (b0 - b1));
    10ec:	00108040 	sll	s0,s0,0x1

      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
    10f0:	03242023 	subu	a0,t9,a0
      c2 = MSCALE ((c3d16 * a1) + (c5d16 * a2));
      c3 = MSCALE ((c1d16 * a0) + (c7d16 * a3));
      ...
      a0 = MSCALE (c1d4 * (b0 + b1));
    10f4:	00094a43 	sra	t1,t1,0x9
      a1 = MSCALE (c1d4 * (b0 - b1));
    10f8:	00108243 	sra	s0,s0,0x9

      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
    10fc:	00042243 	sra	a0,a0,0x9
      a3 = MSCALE ((c1d8 * b2) + (c3d8 * b3));
    1100:	0018c243 	sra	t8,t8,0x9
      a1 = c0 - c1;
      a2 = c3 - c2;
      a3 = c3 + c2;
      ...
      c0 = a0;
      c1 = MSCALE (c1d4 * (a2 - a1));
    1104:	00073840 	sll	a3,a3,0x1
      c2 = MSCALE (c1d4 * (a2 + a1));
    1108:	00063040 	sll	a2,a2,0x1
      a2 = MSCALE ((c3d8 * b2) - (c1d8 * b3));
      a3 = MSCALE ((c1d8 * b2) + (c3d8 * b3));
      ...
      b0 = a0 + a3;
    110c:	03091821 	addu	v1,t8,t1
      b1 = a1 + a2;
    1110:	00907021 	addu	t6,a0,s0
      b2 = a1 - a2;
      b3 = a0 - a3;
      ...
      a0 = c0 + c1;
    1114:	01ac6021 	addu	t4,t5,t4
      a1 = c0 - c1;
      a2 = c3 - c2;
      a3 = c3 + c2;
    1118:	016a5021 	addu	t2,t3,t2
      ...
      b1 = a1 + a2;
      b2 = a1 - a2;
    111c:	02042023 	subu	a0,s0,a0
      b3 = a0 - a3;
    1120:	01384823 	subu	t1,t1,t8
      a1 = c0 - c1;
      a2 = c3 - c2;
      a3 = c3 + c2;
      ...
      c0 = a0;
      c1 = MSCALE (c1d4 * (a2 - a1));
    1124:	00073a43 	sra	a3,a3,0x9
      c2 = MSCALE (c1d4 * (a2 + a1));
    1128:	00063243 	sra	a2,a2,0x9
      c3 = a3;

      aptr = y + LS (i, 3);
      *(aptr++) = b0 + c3;
    112c:	01437821 	addu	t7,t2,v1
      *(aptr++) = b1 + c2;
    1130:	00ce6821 	addu	t5,a2,t6
      *(aptr++) = b2 + c1;
    1134:	00e45821 	addu	t3,a3,a0
      *(aptr++) = b3 + c0;
    1138:	01894021 	addu	t0,t4,t1
      *(aptr++) = b3 - c0;
      *(aptr++) = b2 - c1;
    113c:	00873823 	subu	a3,a0,a3
      aptr = y + LS (i, 3);
      *(aptr++) = b0 + c3;
      *(aptr++) = b1 + c2;
      *(aptr++) = b2 + c1;
      *(aptr++) = b3 + c0;
      *(aptr++) = b3 - c0;
    1140:	012c6023 	subu	t4,t1,t4
      *(aptr++) = b2 - c1;
      *(aptr++) = b1 - c2;
    1144:	01c63023 	subu	a2,t6,a2
      *(aptr) = b0 - c3;
    1148:	006a5023 	subu	t2,v1,t2
      *aptr = b0 - c3;
    }
  ...
  for (i = 0; i < 8; i++)
    114c:	24a50001 	addiu	a1,a1,1
      ...
      aptr = y + LS (i, 3);
      *(aptr++) = b0 + c3;
    1150:	ac4f0000 	sw	t7,0(v0)
      *(aptr++) = b1 + c2;
    1154:	ac4d0004 	sw	t5,4(v0)
      *(aptr++) = b2 + c1;
    1158:	ac4b0008 	sw	t3,8(v0)
      *(aptr++) = b3 + c0;
    115c:	ac48000c 	sw	t0,12(v0)
      *(aptr++) = b3 - c0;
    1160:	ac4c0010 	sw	t4,16(v0)
      *(aptr++) = b2 - c1;
    1164:	ac470014 	sw	a3,20(v0)
      *(aptr++) = b1 - c2;
    1168:	ac460018 	sw	a2,24(v0)
      *aptr = b0 - c3;
    }
  ...
  for (i = 0; i < 8; i++)
    116c:	14b6ff78 	bne	a1,s6,f50 <ChenIDct+0x280>
    1170:	ac4a001c 	sw	t2,28(v0)
    1174:	8fa2002c 	lw	v0,44(sp)
    1178:	00002021 	addu	a0,zero,zero
  /*
  ...
  for (i = 0, aptr = y; i < 64; i++, aptr++)
    117c:	08000466 	j	1198 <ChenIDct+0x4c8>
    1180:	24060040 	addiu	a2,zero,64
    *aptr = (((*aptr < 0) ? (*aptr - 8) : (*aptr + 8)) / 16);
    1184:	00051903 	sra	v1,a1,0x4
  /*
     Retrieve correct accuracy. We have additional factor
     of 16 that must be removed.
   */
  ...
  for (i = 0, aptr = y; i < 64; i++, aptr++)
    1188:	24840001 	addiu	a0,a0,1
    118c:	1086000e 	beq	a0,a2,11c8 <ChenIDct+0x4f8>
    1190:	ac430000 	sw	v1,0(v0)
    1194:	24420004 	addiu	v0,v0,4
    *aptr = (((*aptr < 0) ? (*aptr - 8) : (*aptr + 8)) / 16);
    1198:	8c430000 	lw	v1,0(v0)
    119c:	00000000 	sll	zero,zero,0x0
    11a0:	0461fff8 	bgez	v1,1184 <ChenIDct+0x4b4>
    11a4:	24650008 	addiu	a1,v1,8
    11a8:	2465fff8 	addiu	a1,v1,-8
    11ac:	04a1fff5 	bgez	a1,1184 <ChenIDct+0x4b4>
    11b0:	00000000 	sll	zero,zero,0x0
    11b4:	24650007 	addiu	a1,v1,7
    11b8:	00051903 	sra	v1,a1,0x4
  /*
     Retrieve correct accuracy. We have additional factor
     of 16 that must be removed.
   */
  ...
  for (i = 0, aptr = y; i < 64; i++, aptr++)
    11bc:	24840001 	addiu	a0,a0,1
    11c0:	1486fff4 	bne	a0,a2,1194 <ChenIDct+0x4c4>
    11c4:	ac430000 	sw	v1,0(v0)
    *aptr = (((*aptr < 0) ? (*aptr - 8) : (*aptr + 8)) / 16);
}
    11c8:	8fbe0024 	lw	s8,36(sp)
    11cc:	8fb70020 	lw	s7,32(sp)
    11d0:	8fb6001c 	lw	s6,28(sp)
    11d4:	8fb50018 	lw	s5,24(sp)
    11d8:	8fb40014 	lw	s4,20(sp)
    11dc:	8fb30010 	lw	s3,16(sp)
    11e0:	8fb2000c 	lw	s2,12(sp)
    11e4:	8fb10008 	lw	s1,8(sp)
    11e8:	8fb00004 	lw	s0,4(sp)
    11ec:	03e00008 	jr	ra
    11f0:	27bd0028 	addiu	sp,sp,40

000011f4 <IZigzagMatrix>:
...
*(omatrix++) = imatrix[zigzag_index[i]];
    1200:	8c430000 	lw	v1,0(v0)
    1204:	24420004 	addiu	v0,v0,4
    1208:	00031880 	sll	v1,v1,0x2
    120c:	00831821 	addu	v1,a0,v1
    1210:	8c630000 	lw	v1,0(v1)
    1214:	00000000 	sll	zero,zero,0x0
    1218:	aca30000 	sw	v1,0(a1)
void
IZigzagMatrix (int *imatrix, int *omatrix)
{
  int i;
  ...
  for (i = 0; i < DCTSIZE2; i++)
    121c:	1446fff8 	bne	v0,a2,1200 <IZigzagMatrix+0xc>
    1220:	24a50004 	addiu	a1,a1,4
    {
...
IQuantize (int *matrix, int *qmatrix)
{
  ...
  for (mptr = matrix; mptr < matrix + DCTSIZE2; mptr++)
    122c:	24020040 	addiu	v0,zero,64
    {
      *mptr = *mptr * (*qmatrix);
    1230:	8ca30000 	lw	v1,0(a1)
    1234:	8c860000 	lw	a2,0(a0)
void
IQuantize (int *matrix, int *qmatrix)
{
  int *mptr;
  ...
  for (mptr = matrix; mptr < matrix + DCTSIZE2; mptr++)
    1238:	2442ffff 	addiu	v0,v0,-1
    {
      *mptr = *mptr * (*qmatrix);
    123c:	00c30018 	mult	a2,v1
      qmatrix++;
    1240:	24a50004 	addiu	a1,a1,4
{
  int *mptr;
...
IQuantize (int *matrix, int *qmatrix)
{
  ...
  for (mptr = matrix; mptr < matrix + DCTSIZE2; mptr++)
    124c:	1440fff8 	bnez	v0,1230 <IQuantize+0x4>
    1250:	24840004 	addiu	a0,a0,4
    {
      *mptr = *mptr * (*qmatrix);
      qmatrix++;
    }
...
PostshiftIDctMatrix (int *matrix, int shift)
{
  int *mptr;
  for (mptr = matrix; mptr < matrix + DCTSIZE2; mptr++)
    125c:	24020040 	addiu	v0,zero,64
    {
      *mptr += shift;
    1260:	8c830000 	lw	v1,0(a0)
 */
void
PostshiftIDctMatrix (int *matrix, int shift)
{
  int *mptr;
  for (mptr = matrix; mptr < matrix + DCTSIZE2; mptr++)
    1264:	2442ffff 	addiu	v0,v0,-1
    {
      *mptr += shift;
    1268:	00651821 	addu	v1,v1,a1
...
PostshiftIDctMatrix (int *matrix, int shift)
{
  int *mptr;
  for (mptr = matrix; mptr < matrix + DCTSIZE2; mptr++)
    1270:	1440fffb 	bnez	v0,1260 <PostshiftIDctMatrix+0x4>
...
BoundIDctMatrix (int *matrix, int Bound)
{
  ...
  for (mptr = matrix; mptr < matrix + DCTSIZE2; mptr++)
    1280:	080004a8 	j	12a0 <BoundIDctMatrix+0x20>
    1284:	24020040 	addiu	v0,zero,64
    {
      if (*mptr < 0)
	{
	  *mptr = 0;
    ...
    1288:	10c00002 	beqz	a2,1294 <BoundIDctMatrix+0x14>
    128c:	00000000 	sll	zero,zero,0x0
	{
	  *mptr = Bound;
    1290:	ac850000 	sw	a1,0(a0)
void
BoundIDctMatrix (int *matrix, int Bound)
{
  int *mptr;
  ...
  for (mptr = matrix; mptr < matrix + DCTSIZE2; mptr++)
    1294:	2442ffff 	addiu	v0,v0,-1
    1298:	10400009 	beqz	v0,12c0 <BoundIDctMatrix+0x40>
    129c:	24840004 	addiu	a0,a0,4
    {
      if (*mptr < 0)
    12a0:	8c830000 	lw	v1,0(a0)
    12a4:	00000000 	sll	zero,zero,0x0
    12a8:	0461fff7 	bgez	v1,1288 <BoundIDctMatrix+0x8>
    12ac:	00a3302a 	slt	a2,a1,v1
void
BoundIDctMatrix (int *matrix, int Bound)
{
  int *mptr;
...
BoundIDctMatrix (int *matrix, int Bound)
{
  ...
  for (mptr = matrix; mptr < matrix + DCTSIZE2; mptr++)
    12b8:	1440fff9 	bnez	v0,12a0 <BoundIDctMatrix+0x20>
    12bc:	24840004 	addiu	a0,a0,4
      else if (*mptr > Bound)
	{
	  *mptr = Bound;
	}
...
WriteOneBlock (int *store, char *out_buf, int width, int height,
	       int voffs, int hoffs)
{
    12c8:	8fa20010 	lw	v0,16(sp)
    12cc:	8fa80014 	lw	t0,20(sp)
  ...
  for (i = voffs; i < voffs + DCTSIZE; i++)
    {
      if (i < height)
    12d0:	0047182a 	slt	v1,v0,a3
    12d4:	1060001a 	beqz	v1,1340 <WriteOneBlock+0x78>
    12d8:	24490007 	addiu	t1,v0,7
}
...
WriteOneBlock (int *store, char *out_buf, int width, int height,
  ...
  for (i = voffs; i < voffs + DCTSIZE; i++)
    {
      if (i < height)
    12e0:	250e0007 	addiu	t6,t0,7
    12e4:	0106782a 	slt	t7,t0,a2
}
...
void
WriteOneBlock (int *store, char *out_buf, int width, int height,
    12e8:	00001812 	mflo	v1
    12ec:	00681821 	addu	v1,v1,t0
    12f0:	00a32821 	addu	a1,a1,v1
	{
	  int diff;
	  diff = width * i;
	  for (e = hoffs; e < hoffs + DCTSIZE; e++)
	    {
	      if (e < width)
    12f4:	11e0000c 	beqz	t7,1328 <WriteOneBlock+0x60>
    12f8:	01001821 	addu	v1,t0,zero
    12fc:	080004c3 	j	130c <WriteOneBlock+0x44>
    1300:	00a05021 	addu	t2,a1,zero
    1304:	11a00008 	beqz	t5,1328 <WriteOneBlock+0x60>
    1308:	254a0001 	addiu	t2,t2,1
		{
		  out_buf[diff + e] = (unsigned char) (*(store++));
    130c:	8c8c0000 	lw	t4,0(a0)
    {
      if (i < height)
	{
	  int diff;
	  diff = width * i;
	  for (e = hoffs; e < hoffs + DCTSIZE; e++)
    1310:	24630001 	addiu	v1,v1,1
    1314:	01c3582a 	slt	t3,t6,v1
	    {
	      if (e < width)
    1318:	0066682a 	slt	t5,v1,a2
		{
		  out_buf[diff + e] = (unsigned char) (*(store++));
    131c:	a14c0000 	sb	t4,0(t2)
    {
      if (i < height)
	{
	  int diff;
	  diff = width * i;
	  for (e = hoffs; e < hoffs + DCTSIZE; e++)
    1320:	1160fff8 	beqz	t3,1304 <WriteOneBlock+0x3c>
    1324:	24840004 	addiu	a0,a0,4
{
  int i, e;
  ...
  /* Find vertical buffer offs. */
  for (i = voffs; i < voffs + DCTSIZE; i++)
    1328:	24420001 	addiu	v0,v0,1
    132c:	0122182a 	slt	v1,t1,v0
    1330:	14600003 	bnez	v1,1340 <WriteOneBlock+0x78>
    1334:	0047182a 	slt	v1,v0,a3
    {
      if (i < height)
    1338:	1460ffee 	bnez	v1,12f4 <WriteOneBlock+0x2c>
    133c:	00a62821 	addu	a1,a1,a2
    1340:	03e00008 	jr	ra
...
{
    1348:	27bdffe0 	addiu	sp,sp,-32
    134c:	afb00018 	sw	s0,24(sp)
    1350:	00c08021 	addu	s0,a2,zero
  int voffs, hoffs;
  ...
  voffs = *p_out_vpos * DCTSIZE;
    1354:	8ca30000 	lw	v1,0(a1)
  hoffs = *p_out_hpos * DCTSIZE;
    1358:	8e020000 	lw	v0,0(s0)

  /*
   * Write block
   */
  WriteOneBlock (store,
    135c:	87880000 	lh	t0,0(gp)
    1360:	87860000 	lh	a2,0(gp)
  int voffs, hoffs;
   ...
   */
  voffs = *p_out_vpos * DCTSIZE;
    1364:	000318c0 	sll	v1,v1,0x3
  hoffs = *p_out_hpos * DCTSIZE;
    1368:	000210c0 	sll	v0,v0,0x3
	    ...
	    unsigned char *p_out_buf)
{
   ...
   */
  WriteOneBlock (store,
    137c:	0c000000 	jal	0 <pgetc>
    1380:	01003821 	addu	a3,t0,zero
   *  Add positions
   */
  *p_out_hpos++;
  *p_out_vpos++;
  ...
  if (*p_out_hpos < p_jinfo_MCUWidth)
    1384:	8e030004 	lw	v1,4(s0)
    1388:	8f820000 	lw	v0,0(gp)
    138c:	00000000 	sll	zero,zero,0x0
    1390:	0062102a 	slt	v0,v1,v0
    1394:	14400002 	bnez	v0,13a0 <WriteBlock+0x58>
    ...
    139c:	ae000004 	sw	zero,4(s0)
    }
}
    13a0:	8fbf001c 	lw	ra,28(sp)
    13a4:	8fb00018 	lw	s0,24(sp)
    13a8:	03e00008 	jr	ra
    13ac:	27bd0020 	addiu	sp,sp,32

000013b0 <Write4Blocks>:
 *  4:1:1
 */
void
...
{
    13b0:	27bdffc0 	addiu	sp,sp,-64
    13b4:	afb20020 	sw	s2,32(sp)
    13b8:	afb00018 	sw	s0,24(sp)
    13bc:	8fb20050 	lw	s2,80(sp)
    13c0:	8fb00054 	lw	s0,84(sp)
   * OX
   * XX
   */
  voffs = *p_out_vpos * DCTSIZE;
  ...
  WriteOneBlock (store1, p_out_buf,
    13c4:	87830000 	lh	v1,0(gp)
    13c8:	87820000 	lh	v0,0(gp)
 *  4:1:1
 */
void
Write4Blocks (int *store1, int *store2, int *store3, int *store4,
	      int *p_out_vpos, int *p_out_hpos, unsigned char *p_out_buf)
{
    13cc:	afb40028 	sw	s4,40(sp)
    13d0:	afb30024 	sw	s3,36(sp)
   ...
   */
  voffs = *p_out_vpos * DCTSIZE;
    13d4:	8e540000 	lw	s4,0(s2)
  hoffs = *p_out_hpos * DCTSIZE;
    13d8:	8e130000 	lw	s3,0(s0)
 *  4:1:1
 */
void
Write4Blocks (int *store1, int *store2, int *store3, int *store4,
	      int *p_out_vpos, int *p_out_hpos, unsigned char *p_out_buf)
{
    13dc:	afb1001c 	sw	s1,28(sp)
    13e0:	8fb10058 	lw	s1,88(sp)
   ...
   */
  voffs = *p_out_vpos * DCTSIZE;
    13e4:	0014a0c0 	sll	s4,s4,0x3
  hoffs = *p_out_hpos * DCTSIZE;
    13e8:	001398c0 	sll	s3,s3,0x3
 *  4:1:1
 */
void
Write4Blocks (int *store1, int *store2, int *store3, int *store4,
	      int *p_out_vpos, int *p_out_hpos, unsigned char *p_out_buf)
{
    13ec:	afbe0038 	sw	s8,56(sp)
    13f0:	afb70034 	sw	s7,52(sp)
    13f4:	afb60030 	sw	s6,48(sp)
    13f8:	00a0f021 	addu	s8,a1,zero
    13fc:	00c0b821 	addu	s7,a2,zero
    1400:	00e0b021 	addu	s6,a3,zero
   * OX
   * XX
   */
  voffs = *p_out_vpos * DCTSIZE;
  hoffs = *p_out_hpos * DCTSIZE;
  WriteOneBlock (store1, p_out_buf,
    1404:	00603021 	addu	a2,v1,zero
    1408:	00403821 	addu	a3,v0,zero
    140c:	02202821 	addu	a1,s1,zero
 *  4:1:1
 */
void
Write4Blocks (int *store1, int *store2, int *store3, int *store4,
	      int *p_out_vpos, int *p_out_hpos, unsigned char *p_out_buf)
{
    1410:	afbf003c 	sw	ra,60(sp)
    1414:	afb5002c 	sw	s5,44(sp)
   * OX
   * XX
   */
  voffs = *p_out_vpos * DCTSIZE;
  hoffs = *p_out_hpos * DCTSIZE;
  WriteOneBlock (store1, p_out_buf,
    1418:	afb40010 	sw	s4,16(sp)
    141c:	0c000000 	jal	0 <pgetc>
    1420:	afb30014 	sw	s3,20(sp)
  /*
   * XO
   * XX
   */
  ...
  WriteOneBlock (store2, p_out_buf,
    1424:	87860000 	lh	a2,0(gp)
    1428:	87870000 	lh	a3,0(gp)
   ...
   */
  hoffs += DCTSIZE;
    142c:	26750008 	addiu	s5,s3,8
  WriteOneBlock (store2, p_out_buf,
    1430:	03c02021 	addu	a0,s8,zero
    1434:	02202821 	addu	a1,s1,zero
    1438:	afb40010 	sw	s4,16(sp)
    143c:	0c000000 	jal	0 <pgetc>
    1440:	afb50014 	sw	s5,20(sp)
   * XX
   * OX
   */
  voffs += DCTSIZE;
  ...
  WriteOneBlock (store3, p_out_buf,
    1444:	87860000 	lh	a2,0(gp)
    1448:	87870000 	lh	a3,0(gp)
   ...
   */
  voffs += DCTSIZE;
    144c:	26940008 	addiu	s4,s4,8
  hoffs -= DCTSIZE;
  WriteOneBlock (store3, p_out_buf,
    1450:	02e02021 	addu	a0,s7,zero
    1454:	02202821 	addu	a1,s1,zero
    1458:	afb40010 	sw	s4,16(sp)
    145c:	0c000000 	jal	0 <pgetc>
    1460:	afb30014 	sw	s3,20(sp)
  /*
   * XX
   * XO
   */
  ...
  WriteOneBlock (store4,
    1464:	87860000 	lh	a2,0(gp)
    1468:	87870000 	lh	a3,0(gp)
    146c:	02c02021 	addu	a0,s6,zero
    1470:	02202821 	addu	a1,s1,zero
    1474:	afb40010 	sw	s4,16(sp)
    1478:	0c000000 	jal	0 <pgetc>
    147c:	afb50014 	sw	s5,20(sp)
		 voffs, hoffs);
  ...
  *p_out_hpos = *p_out_hpos + 2;
    1480:	8e020000 	lw	v0,0(s0)
    1484:	00000000 	sll	zero,zero,0x0
    1488:	24420002 	addiu	v0,v0,2
    148c:	ae020000 	sw	v0,0(s0)
  *p_out_vpos = *p_out_vpos + 2;
    1490:	8e420000 	lw	v0,0(s2)
    1494:	00000000 	sll	zero,zero,0x0
    1498:	24430002 	addiu	v1,v0,2
    149c:	ae430000 	sw	v1,0(s2)


  if (*p_out_hpos < p_jinfo_MCUWidth)
    14a0:	8e040000 	lw	a0,0(s0)
    14a4:	8f830000 	lw	v1,0(gp)
    14a8:	00000000 	sll	zero,zero,0x0
    14ac:	0083182a 	slt	v1,a0,v1
    14b0:	1460000e 	bnez	v1,14ec <Write4Blocks+0x13c>
    ...
    {
      *p_out_hpos = 0;		/* If at end of image (width) */
    14b8:	ae000000 	sw	zero,0(s0)
    }
}
    14bc:	8fbf003c 	lw	ra,60(sp)
    14c0:	8fbe0038 	lw	s8,56(sp)
    14c4:	8fb70034 	lw	s7,52(sp)
    14c8:	8fb60030 	lw	s6,48(sp)
    14cc:	8fb5002c 	lw	s5,44(sp)
    14d0:	8fb40028 	lw	s4,40(sp)
    14d4:	8fb30024 	lw	s3,36(sp)
    14d8:	8fb20020 	lw	s2,32(sp)
    14dc:	8fb1001c 	lw	s1,28(sp)
    14e0:	8fb00018 	lw	s0,24(sp)
    14e4:	03e00008 	jr	ra
    14e8:	27bd0040 	addiu	sp,sp,64
  *p_out_vpos = *p_out_vpos + 2;
  ...
  if (*p_out_hpos < p_jinfo_MCUWidth)
    {
      *p_out_vpos = *p_out_vpos - 2;
    14ec:	0800052f 	j	14bc <Write4Blocks+0x10c>
    14f0:	ae420000 	sw	v0,0(s2)
...
YuvToRgb (int p, int *y_buf, int *u_buf, int *v_buf)
    14f4:	00041200 	sll	v0,a0,0x8
    14f8:	00042280 	sll	a0,a0,0xa
    14fc:	00822023 	subu	a0,a0,v0
    1500:	3c020000 	lui	v0,0x0
{
    1504:	27bdfff8 	addiu	sp,sp,-8
...
void
YuvToRgb (int p, int *y_buf, int *u_buf, int *v_buf)
    1510:	00442021 	addu	a0,v0,a0
    1514:	00004021 	addu	t0,zero,zero
{
  int r, g, b;
  int y, u, v;
  int i;
  ...
  for (i = 0; i < DCTSIZE2; i++)
    1518:	240d0100 	addiu	t5,zero,256
...
void
YuvToRgb (int p, int *y_buf, int *u_buf, int *v_buf)
    151c:	00e81821 	addu	v1,a3,t0
    1520:	00c81021 	addu	v0,a2,t0
  ...
  for (i = 0; i < DCTSIZE2; i++)
    {
      y = y_buf[i];
      u = u_buf[i] - 128;
    1530:	2442ff80 	addiu	v0,v0,-128
      v = v_buf[i] - 128;

      r = (y * 256 + v * 359 + 128) >> 8;
    1534:	00035940 	sll	t3,v1,0x5
    1538:	000350c0 	sll	t2,v1,0x3
...
YuvToRgb (int p, int *y_buf, int *u_buf, int *v_buf)
    153c:	00a84821 	addu	t1,a1,t0
    {
      ...
      r = (y * 256 + v * 359 + 128) >> 8;
    1540:	016a5023 	subu	t2,t3,t2
      g = (y * 256 - u * 88 - v * 182 + 128) >> 8;
    1544:	00038100 	sll	s0,v1,0x4
    1548:	00035880 	sll	t3,v1,0x2
      b = (y * 256 + u * 454 + 128) >> 8;
    154c:	000260c0 	sll	t4,v0,0x3
    1550:	0002c980 	sll	t9,v0,0x6
    {
      y = y_buf[i];
      u = u_buf[i] - 128;
      v = v_buf[i] - 128;
      ...
      r = (y * 256 + v * 359 + 128) >> 8;
    1554:	8d290000 	lw	t1,0(t1)
    1558:	000a7100 	sll	t6,t2,0x4
      g = (y * 256 - u * 88 - v * 182 + 128) >> 8;
    155c:	00027880 	sll	t7,v0,0x2
    1560:	0002c100 	sll	t8,v0,0x4
    1564:	020b5823 	subu	t3,s0,t3
      b = (y * 256 + u * 454 + 128) >> 8;
    1568:	032c6023 	subu	t4,t9,t4
      y = y_buf[i];
      u = u_buf[i] - 128;
      v = v_buf[i] - 128;
    ...
    156c:	01635821 	addu	t3,t3,v1
    {
      ...
      r = (y * 256 + v * 359 + 128) >> 8;
    1570:	01ca7023 	subu	t6,t6,t2
      g = (y * 256 - u * 88 - v * 182 + 128) >> 8;
      b = (y * 256 + u * 454 + 128) >> 8;
    1574:	01826021 	addu	t4,t4,v0
    {
      y = y_buf[i];
      u = u_buf[i] - 128;
      v = v_buf[i] - 128;
      ...
      r = (y * 256 + v * 359 + 128) >> 8;
    1578:	00094a00 	sll	t1,t1,0x8
      g = (y * 256 - u * 88 - v * 182 + 128) >> 8;
    157c:	030f5023 	subu	t2,t8,t7
    {
      y = y_buf[i];
      u = u_buf[i] - 128;
      v = v_buf[i] - 128;
      ...
      r = (y * 256 + v * 359 + 128) >> 8;
    1580:	25290080 	addiu	t1,t1,128
    1584:	01c31823 	subu	v1,t6,v1
      g = (y * 256 - u * 88 - v * 182 + 128) >> 8;
    1588:	004a5023 	subu	t2,v0,t2
      b = (y * 256 + u * 454 + 128) >> 8;
    158c:	000c6080 	sll	t4,t4,0x2
      y = y_buf[i];
      u = u_buf[i] - 128;
      v = v_buf[i] - 128;
    ...
    1590:	000b70c0 	sll	t6,t3,0x3
    {
      ...
      r = (y * 256 + v * 359 + 128) >> 8;
    1594:	01231821 	addu	v1,t1,v1
      g = (y * 256 - u * 88 - v * 182 + 128) >> 8;
      b = (y * 256 + u * 454 + 128) >> 8;
    1598:	01821023 	subu	v0,t4,v0
      y = y_buf[i];
      u = u_buf[i] - 128;
      v = v_buf[i] - 128;
      ...
      r = (y * 256 + v * 359 + 128) >> 8;
      g = (y * 256 - u * 88 - v * 182 + 128) >> 8;
    159c:	000a50c0 	sll	t2,t2,0x3
    15a0:	016e5823 	subu	t3,t3,t6
    15a4:	01495021 	addu	t2,t2,t1
    15a8:	000b5840 	sll	t3,t3,0x1
      b = (y * 256 + u * 454 + 128) >> 8;
    15ac:	00021040 	sll	v0,v0,0x1
    15b0:	00031a03 	sra	v1,v1,0x8
      y = y_buf[i];
      u = u_buf[i] - 128;
      v = v_buf[i] - 128;
      ...
      r = (y * 256 + v * 359 + 128) >> 8;
      g = (y * 256 - u * 88 - v * 182 + 128) >> 8;
    15b4:	014b5021 	addu	t2,t2,t3
      b = (y * 256 + u * 454 + 128) >> 8;
    15b8:	00494821 	addu	t1,v0,t1
    15bc:	286c0100 	slti	t4,v1,256
      y = y_buf[i];
      u = u_buf[i] - 128;
      v = v_buf[i] - 128;
      ...
      r = (y * 256 + v * 359 + 128) >> 8;
      g = (y * 256 - u * 88 - v * 182 + 128) >> 8;
    15c0:	000a5203 	sra	t2,t2,0x8
      b = (y * 256 + u * 454 + 128) >> 8;
    15c4:	15800002 	bnez	t4,15d0 <YuvToRgb+0xdc>
    15c8:	00094a03 	sra	t1,t1,0x8
    15cc:	240300ff 	addiu	v1,zero,255
    15d0:	29420100 	slti	v0,t2,256
    15d4:	14400002 	bnez	v0,15e0 <YuvToRgb+0xec>
    15d8:	29220100 	slti	v0,t1,256
    15dc:	240a00ff 	addiu	t2,zero,255
    15e0:	14400002 	bnez	v0,15ec <YuvToRgb+0xf8>
    15e4:	00000000 	sll	zero,zero,0x0
    15e8:	240900ff 	addiu	t1,zero,255
      if (b < 0)
	b = 0;
      else if (b > 255)
	b = 255;
      ...
      rgb_buf[p][0][i] = r;
    15ec:	04600010 	bltz	v1,1630 <YuvToRgb+0x13c>
    15f0:	00000000 	sll	zero,zero,0x0
      rgb_buf[p][1][i] = g;
    15f4:	0540000c 	bltz	t2,1628 <YuvToRgb+0x134>
    15f8:	ac830000 	sw	v1,0(a0)
      rgb_buf[p][2][i] = b;
    15fc:	05200008 	bltz	t1,1620 <YuvToRgb+0x12c>
    1600:	ac8a0100 	sw	t2,256(a0)
    1604:	25080004 	addiu	t0,t0,4
    1608:	ac890200 	sw	t1,512(a0)
{
  int r, g, b;
  int y, u, v;
  int i;
  ...
  for (i = 0; i < DCTSIZE2; i++)
    160c:	150dffc3 	bne	t0,t5,151c <YuvToRgb+0x28>
    1610:	24840004 	addiu	a0,a0,4
      rgb_buf[p][0][i] = r;
      rgb_buf[p][1][i] = g;
      rgb_buf[p][2][i] = b;
    ...
    1614:	8fb00004 	lw	s0,4(sp)
    1618:	03e00008 	jr	ra
    161c:	27bd0008 	addiu	sp,sp,8
      else if (b > 255)
	b = 255;
      ...
      rgb_buf[p][1][i] = g;
      rgb_buf[p][2][i] = b;
    1620:	08000581 	j	1604 <YuvToRgb+0x110>
    1624:	00004821 	addu	t1,zero,zero
	b = 0;
      else if (b > 255)
	b = 255;
      ...
      rgb_buf[p][0][i] = r;
      rgb_buf[p][1][i] = g;
    1628:	0800057f 	j	15fc <YuvToRgb+0x108>
    162c:	00005021 	addu	t2,zero,zero
      if (b < 0)
	b = 0;
      else if (b > 255)
	b = 255;
      ...
      rgb_buf[p][0][i] = r;
    1630:	0800057d 	j	15f4 <YuvToRgb+0x100>
    1634:	00001821 	addu	v1,zero,zero
...
buf_getb ()
{
    163c:	27bdffe8 	addiu	sp,sp,-24
  if (read_position < 0)
    1640:	0460000e 	bltz	v1,167c <buf_getb+0x44>
    1644:	afbf0014 	sw	ra,20(sp)
    {
...
buf_getb ()
{
  ...
  if (current_read_byte & bit_set_mask[read_position--])
    1650:	24840000 	addiu	a0,a0,0
    1654:	00031880 	sll	v1,v1,0x2
    1658:	00641821 	addu	v1,v1,a0
 * buf_getb() gets a bit from the read stream.
 */
int
buf_getb ()
{
  ...
  if (current_read_byte & bit_set_mask[read_position--])
    1668:	00431024 	and	v0,v0,v1
    {
      return (1);
    }
  return (0);
}
    166c:	0002102b 	sltu	v0,zero,v0
    {
      current_read_byte = pgetc ();
      read_position = 7;
    }
...
buf_getb ()
{
  if (read_position < 0)
    {
      current_read_byte = pgetc ();
    167c:	0c000000 	jal	0 <pgetc>
    1680:	00000000 	sll	zero,zero,0x0
    1684:	24030007 	addiu	v1,zero,7
      read_position = 7;
    }

  if (current_read_byte & bit_set_mask[read_position--])
    1688:	3c040000 	lui	a0,0x0
    168c:	00031880 	sll	v1,v1,0x2
    1690:	24840000 	addiu	a0,a0,0
    1694:	00641821 	addu	v1,v1,a0
    1698:	8c630000 	lw	v1,0(v1)
    {
      return (1);
    }
  return (0);
...
buf_getb ()
{
  if (read_position < 0)
    {
      current_read_byte = pgetc ();
    16a0:	af820010 	sw	v0,16(gp)
    16a4:	24050006 	addiu	a1,zero,6
      read_position = 7;
    }

  if (current_read_byte & bit_set_mask[read_position--])
    16a8:	00431024 	and	v0,v0,v1
    {
      return (1);
    }
  return (0);
}
    16ac:	0002102b 	sltu	v0,zero,v0
    {
      current_read_byte = pgetc ();
      read_position = 7;
    }
...
buf_getv (int n)
{
    16c4:	afb20018 	sw	s2,24(sp)
  int p, rv;

  n--;
    16c8:	2492ffff 	addiu	s2,a0,-1
 * megetv() gets n bits from the read stream and returns it.
 *
 */
int
buf_getv (int n)
{
    16cc:	afb00010 	sw	s0,16(sp)
  int p, rv;

  n--;
  p = n - read_position;
    16d0:	02428023 	subu	s0,s2,v0
 * megetv() gets n bits from the read stream and returns it.
 *
 */
int
buf_getv (int n)
{
    16d4:	afbf001c 	sw	ra,28(sp)
  int p, rv;

  n--;
  p = n - read_position;
  while (p > 0)
    16d8:	1a00004a 	blez	s0,1804 <buf_getv+0x148>
    16dc:	afb10014 	sw	s1,20(sp)
    {
      if (read_position > 23)
    16e0:	28420018 	slti	v0,v0,24
    16e4:	10400023 	beqz	v0,1774 <buf_getv+0xb8>
    16e8:	00000000 	sll	zero,zero,0x0
	  ...
	  read_position = 7 - p;
	  return (rv & lmask[n]);
    16ec:	8f910010 	lw	s1,16(gp)
    16f0:	080005c0 	j	1700 <buf_getv+0x44>
  ...
  while (p > 0)
    {
      if (read_position > 23)
    16f8:	1040001f 	beqz	v0,1778 <buf_getv+0xbc>
    ...
    1700:	0c000000 	jal	0 <pgetc>
    1704:	00118a00 	sll	s1,s1,0x8
      read_position += 8;	/* else shift in new information */
    1708:	8f83003c 	lw	v1,60(gp)
    170c:	00000000 	sll	zero,zero,0x0
    1710:	24630008 	addiu	v1,v1,8
	  rv |= (current_read_byte >> (8 - p));
	  read_position = 7 - p;
	  return (rv & lmask[n]);
	  /* Can return pending residual val */
      ...
      current_read_byte = (current_read_byte << 8) | pgetc ();
    1714:	00518825 	or	s1,v0,s1
      read_position += 8;	/* else shift in new information */
      p -= 8;
    1718:	2610fff8 	addiu	s0,s0,-8
    ...
    1720:	af910010 	sw	s1,16(gp)
{
  ...
  p = n - read_position;
  while (p > 0)
    1724:	1e00fff4 	bgtz	s0,16f8 <buf_getv+0x3c>
    1728:	af83003c 	sw	v1,60(gp)
      current_read_byte = (current_read_byte << 8) | pgetc ();
      read_position += 8;	/* else shift in new information */
      p -= 8;
    }
  ...
  if (!p)
    172c:	12000028 	beqz	s0,17d0 <buf_getv+0x114>
  ...
  return ((current_read_byte >> p) & lmask[n]);
    1734:	3c020000 	lui	v0,0x0
    1738:	24420000 	addiu	v0,v0,0
    173c:	00129080 	sll	s2,s2,0x2
    1740:	02429021 	addu	s2,s2,v0
      read_position = -1;
  ...
  p = -p;
    1744:	00108023 	negu	s0,s0
  /* Else reverse position and shift */
  read_position = p - 1;
  return ((current_read_byte >> p) & lmask[n]);
    1748:	8e430000 	lw	v1,0(s2)
}
  ...
  /* Else reverse position and shift */
  read_position = p - 1;
    1750:	2602ffff 	addiu	v0,s0,-1
  return ((current_read_byte >> p) & lmask[n]);
    1754:	02118806 	srlv	s1,s1,s0
      return (current_read_byte & lmask[n]);
    }
  ...
  /* Else reverse position and shift */
  read_position = p - 1;
    1758:	af82003c 	sw	v0,60(gp)
  return ((current_read_byte >> p) & lmask[n]);
}
    175c:	8fb20018 	lw	s2,24(sp)
    }
  ...
  read_position = p - 1;
  return ((current_read_byte >> p) & lmask[n]);
    1760:	02231024 	and	v0,s1,v1
}
    1764:	8fb10014 	lw	s1,20(sp)
    1768:	8fb00010 	lw	s0,16(sp)
    176c:	03e00008 	jr	ra
    1770:	27bd0020 	addiu	sp,sp,32
  ...
  while (p > 0)
    {
      if (read_position > 23)
    1774:	8f910010 	lw	s1,16(gp)
	{			/* If byte buffer contains almost entire word */
	  rv = (current_read_byte << p);	/* Manipulate buffer */
	  current_read_byte = pgetc ();	/* Change read bytes */
    1778:	0c000000 	jal	0 <pgetc>
    177c:	00129080 	sll	s2,s2,0x2
	...
	{			/* If byte buffer contains almost entire word */
	  ...
	  rv |= (current_read_byte >> (8 - p));
    1788:	24040008 	addiu	a0,zero,8
    178c:	00902023 	subu	a0,a0,s0
	  read_position = 7 - p;
	  return (rv & lmask[n]);
    1790:	02439021 	addu	s2,s2,v1
      if (read_position > 23)
	{			/* If byte buffer contains almost entire word */
	  rv = (current_read_byte << p);	/* Manipulate buffer */
	  current_read_byte = pgetc ();	/* Change read bytes */
  ...
  while (p > 0)
	...
	{			/* If byte buffer contains almost entire word */
	  rv = (current_read_byte << p);	/* Manipulate buffer */
    1798:	02118804 	sllv	s1,s1,s0
	  current_read_byte = pgetc ();	/* Change read bytes */

	  rv |= (current_read_byte >> (8 - p));
	  read_position = 7 - p;
	  return (rv & lmask[n]);
    179c:	8e430000 	lw	v1,0(s2)
	{			/* If byte buffer contains almost entire word */
	  rv = (current_read_byte << p);	/* Manipulate buffer */
	  current_read_byte = pgetc ();	/* Change read bytes */
  ...
  while (p > 0)
	...
	{			/* If byte buffer contains almost entire word */
	  rv = (current_read_byte << p);	/* Manipulate buffer */
	  current_read_byte = pgetc ();	/* Change read bytes */
    17b0:	af820010 	sw	v0,16(gp)

	  rv |= (current_read_byte >> (8 - p));
	  read_position = 7 - p;
    17b4:	af90003c 	sw	s0,60(gp)
	  return (rv & lmask[n]);
    17b8:	02231024 	and	v0,s1,v1
  ...
  return ((current_read_byte >> p) & lmask[n]);
    ...
    17bc:	8fb20018 	lw	s2,24(sp)
    17c0:	8fb10014 	lw	s1,20(sp)
    17c4:	8fb00010 	lw	s0,16(sp)
    17c8:	03e00008 	jr	ra
  ...
  if (!p)
    {				/* If position is zero */
      ...
      /* Can return current byte */
      return (current_read_byte & lmask[n]);
    17d0:	24420000 	addiu	v0,v0,0
    17d4:	00129080 	sll	s2,s2,0x2
    17d8:	02429021 	addu	s2,s2,v0
    17dc:	8e420000 	lw	v0,0(s2)
  ...
  if (!p)
    {				/* If position is zero */
      read_position = -1;
    17e4:	2403ffff 	addiu	v1,zero,-1
      /* Can return current byte */
      return (current_read_byte & lmask[n]);
    17e8:	02221024 	and	v0,s1,v0
  ...
  return ((current_read_byte >> p) & lmask[n]);
    ...
    17ec:	8fb20018 	lw	s2,24(sp)
    17f0:	8fb10014 	lw	s1,20(sp)
    17f4:	8fb00010 	lw	s0,16(sp)
      p -= 8;
    }
    ...
    1800:	27bd0020 	addiu	sp,sp,32
{
  ...
  if (!p)
    1808:	1600ffca 	bnez	s0,1734 <buf_getv+0x78>
    180c:	3c020000 	lui	v0,0x0
    {				/* If position is zero */
      read_position = -1;
      /* Can return current byte */
      return (current_read_byte & lmask[n]);
    1810:	080005f5 	j	17d4 <buf_getv+0x118>
    1814:	24420000 	addiu	v0,v0,0

00001818 <huff_make_dhuff_tb>:
 */
int
huff_make_dhuff_tb (int *p_xhtbl_bits, int p_dhtbl_ml,
		    ...
		    int *p_dhtbl_valptr)
{
    1818:	27bdf7f8 	addiu	sp,sp,-2056
...
huff_make_dhuff_tb (int *p_xhtbl_bits, int p_dhtbl_ml,
   ...
   */
  for (p = 0, i = 1; i < 17; i++)
    1820:	24080001 	addiu	t0,zero,1
    1824:	00005821 	addu	t3,zero,zero
    1828:	240c0011 	addiu	t4,zero,17
    {
      for (j = 1; j <= p_xhtbl_bits[i]; j++)
    182c:	8d490004 	lw	t1,4(t2)
    1830:	00000000 	sll	zero,zero,0x0
    1834:	1920000a 	blez	t1,1860 <huff_make_dhuff_tb+0x48>
...
int
huff_make_dhuff_tb (int *p_xhtbl_bits, int p_dhtbl_ml,
    183c:	000b1880 	sll	v1,t3,0x2
    1840:	03a31821 	addu	v1,sp,v1
    1844:	24020001 	addiu	v0,zero,1
  /*
   * Get size
   */
  for (p = 0, i = 1; i < 17; i++)
    {
      for (j = 1; j <= p_xhtbl_bits[i]; j++)
    1848:	24420001 	addiu	v0,v0,1
    184c:	0122282a 	slt	a1,t1,v0
	{
	  huffsize[p++] = i;
    1850:	ac680000 	sw	t0,0(v1)
  /*
   * Get size
   */
  for (p = 0, i = 1; i < 17; i++)
    {
      for (j = 1; j <= p_xhtbl_bits[i]; j++)
    1854:	10a0fffc 	beqz	a1,1848 <huff_make_dhuff_tb+0x30>
    1858:	24630004 	addiu	v1,v1,4
    185c:	01695821 	addu	t3,t3,t1
  int lastp;
   ...
   */
  for (p = 0, i = 1; i < 17; i++)
    1860:	25080001 	addiu	t0,t0,1
    1864:	150cfff1 	bne	t0,t4,182c <huff_make_dhuff_tb+0x14>
    1868:	254a0004 	addiu	t2,t2,4
	{
	  huffsize[p++] = i;
	}
    }
  ...
  huffsize[p] = 0;
    186c:	000b5880 	sll	t3,t3,0x2
    1870:	03ab5821 	addu	t3,sp,t3
    1874:	ad600000 	sw	zero,0(t3)
  lastp = p;

  p = 0;
  code = 0;
  size = huffsize[0];
    1878:	27a90004 	addiu	t1,sp,4
    187c:	8fa80000 	lw	t0,0(sp)
    {
      do
	{
	  huffcode[p++] = code++;
  ...
  p = 0;
  code = 0;
    1884:	00001821 	addu	v1,zero,zero
  size = huffsize[0];
    1888:	27aa0404 	addiu	t2,sp,1028
    }
  ...
  p = 0;
    188c:	00005821 	addu	t3,zero,zero
  size = huffsize[0];
  while (1)
    {
      do
	{
	  huffcode[p++] = code++;
    1890:	ad430000 	sw	v1,0(t2)
    1894:	256b0001 	addiu	t3,t3,1
	}
      while ((huffsize[p] == size) && (p < 257));
    1898:	10a80012 	beq	a1,t0,18e4 <huff_make_dhuff_tb+0xcc>
    189c:	24630001 	addiu	v1,v1,1
      /* Overflow Detection */
      if (!huffsize[p])
    18a0:	10a00016 	beqz	a1,18fc <huff_make_dhuff_tb+0xe4>
    18a4:	24020001 	addiu	v0,zero,1
    18a8:	01001021 	addu	v0,t0,zero
	}
      do
	{
	  ...
	  code <<= 1;
	  size++;
    18ac:	24420001 	addiu	v0,v0,1
	}
      while (huffsize[p] != size);
    18b0:	14a2fffe 	bne	a1,v0,18ac <huff_make_dhuff_tb+0x94>
    18b4:	00031840 	sll	v1,v1,0x1
...
int
huff_make_dhuff_tb (int *p_xhtbl_bits, int p_dhtbl_ml,
    18b8:	00081027 	nor	v0,zero,t0
    18bc:	00452821 	addu	a1,v0,a1
    18c0:	25080001 	addiu	t0,t0,1
    18c4:	01054021 	addu	t0,t0,a1
  huffsize[p] = 0;
  lastp = p;
  ...
  code = 0;
  size = huffsize[0];
    18c8:	254a0004 	addiu	t2,t2,4
    18cc:	25290004 	addiu	t1,t1,4
    {
      do
	{
	  huffcode[p++] = code++;
  ...
  while (1)
	...
	{
	  huffcode[p++] = code++;
    18d4:	ad430000 	sw	v1,0(t2)
    18d8:	256b0001 	addiu	t3,t3,1
	}
      while ((huffsize[p] == size) && (p < 257));
    18dc:	14a8fff0 	bne	a1,t0,18a0 <huff_make_dhuff_tb+0x88>
    18e0:	24630001 	addiu	v1,v1,1
    18e4:	29620101 	slti	v0,t3,257
    18e8:	1040ffed 	beqz	v0,18a0 <huff_make_dhuff_tb+0x88>
  ...
  code = 0;
  size = huffsize[0];
    18f0:	254a0004 	addiu	t2,t2,4
    18f4:	08000634 	j	18d0 <huff_make_dhuff_tb+0xb8>
    18f8:	25290004 	addiu	t1,t1,4
...
int
huff_make_dhuff_tb (int *p_xhtbl_bits, int p_dhtbl_ml,
    18fc:	00c02821 	addu	a1,a2,zero
    1900:	8fa90818 	lw	t1,2072(sp)
	{
	  huffcode[p++] = code++;
	}
      while ((huffsize[p] == size) && (p < 257));
      /* Overflow Detection */
      if (!huffsize[p])
    1904:	24030001 	addiu	v1,zero,1
    1908:	00004021 	addu	t0,zero,zero
  ...
  for (p_dhtbl_ml = 1, p = 0, l = 1; l <= 16; l++)
    1910:	0800064d 	j	1934 <huff_make_dhuff_tb+0x11c>
    1914:	240c0011 	addiu	t4,zero,17
    1918:	24630001 	addiu	v1,v1,1
    {
      if (p_xhtbl_bits[l] == 0)
	{
	  p_dhtbl_maxcode[l] = -1;	/* Watch out JPEG is wrong here */
    191c:	acad0004 	sw	t5,4(a1)
	  size++;
	}
      while (huffsize[p] != size);
    }
  ...
  for (p_dhtbl_ml = 1, p = 0, l = 1; l <= 16; l++)
    1920:	24840004 	addiu	a0,a0,4
    1924:	24a50004 	addiu	a1,a1,4
    1928:	25290004 	addiu	t1,t1,4
    192c:	106c0019 	beq	v1,t4,1994 <huff_make_dhuff_tb+0x17c>
    1930:	24e70004 	addiu	a3,a3,4
	  p_dhtbl_maxcode[l] = -1;	/* Watch out JPEG is wrong here */
	}
      else
    ...
    1934:	00085080 	sll	t2,t0,0x2
    1938:	03aa5821 	addu	t3,sp,t2
      while (huffsize[p] != size);
    }
  ...
  for (p_dhtbl_ml = 1, p = 0, l = 1; l <= 16; l++)
    {
      if (p_xhtbl_bits[l] == 0)
    193c:	8c8a0004 	lw	t2,4(a0)
    1940:	00000000 	sll	zero,zero,0x0
    1944:	1140fff4 	beqz	t2,1918 <huff_make_dhuff_tb+0x100>
	...
	{			/* We use -1 to indicate skipping. */
	  p_dhtbl_valptr[l] = p;
    194c:	ad280004 	sw	t0,4(t1)
	  p_dhtbl_mincode[l] = huffcode[p];
    1950:	8d6a0404 	lw	t2,1028(t3)
	  p += p_xhtbl_bits[l] - 1;
	  p_dhtbl_maxcode[l] = huffcode[p];
	  p_dhtbl_ml = l;
	  p++;
    1954:	00601021 	addu	v0,v1,zero
	  p_dhtbl_maxcode[l] = -1;	/* Watch out JPEG is wrong here */
	}
      else
	{			/* We use -1 to indicate skipping. */
	  p_dhtbl_valptr[l] = p;
	  p_dhtbl_mincode[l] = huffcode[p];
    1958:	acea0004 	sw	t2,4(a3)
	  p += p_xhtbl_bits[l] - 1;
    195c:	8c8a0004 	lw	t2,4(a0)
	  size++;
	}
      while (huffsize[p] != size);
    }
  ...
  for (p_dhtbl_ml = 1, p = 0, l = 1; l <= 16; l++)
	...
	{			/* We use -1 to indicate skipping. */
	  ...
	  p_dhtbl_mincode[l] = huffcode[p];
	  p += p_xhtbl_bits[l] - 1;
    1964:	254affff 	addiu	t2,t2,-1
    1968:	01484021 	addu	t0,t2,t0
	  p_dhtbl_maxcode[l] = huffcode[p];
    196c:	00085080 	sll	t2,t0,0x2
    1970:	03aa5021 	addu	t2,sp,t2
    1974:	8d4a0404 	lw	t2,1028(t2)
	  p_dhtbl_ml = l;
	  p++;
    1978:	25080001 	addiu	t0,t0,1
      else
	{			/* We use -1 to indicate skipping. */
	  p_dhtbl_valptr[l] = p;
	  p_dhtbl_mincode[l] = huffcode[p];
  ...
  for (p_dhtbl_ml = 1, p = 0, l = 1; l <= 16; l++)
    1980:	24840004 	addiu	a0,a0,4
    1984:	24a50004 	addiu	a1,a1,4
    1988:	25290004 	addiu	t1,t1,4
    198c:	146cffe9 	bne	v1,t4,1934 <huff_make_dhuff_tb+0x11c>
    1990:	24e70004 	addiu	a3,a3,4
	  p_dhtbl_maxcode[l] = huffcode[p];
	  p_dhtbl_ml = l;
	  p++;
	}
  ...
  p_dhtbl_maxcode[p_dhtbl_ml]++;
    1994:	00021880 	sll	v1,v0,0x2
    1998:	00c33021 	addu	a2,a2,v1
    199c:	8cc30000 	lw	v1,0(a2)
  return p_dhtbl_ml;
}
    19a0:	27bd0808 	addiu	sp,sp,2056
	  p_dhtbl_maxcode[l] = huffcode[p];
	  p_dhtbl_ml = l;
	  p++;
	}
  ...
  p_dhtbl_maxcode[p_dhtbl_ml]++;
    19a4:	24630001 	addiu	v1,v1,1
  return p_dhtbl_ml;
}
    19a8:	03e00008 	jr	ra
    19ac:	acc30000 	sw	v1,0(a2)

000019b0 <DecodeHuffman>:
 *  
 */
int
	       ...
	       int *Dhuff_maxcode, int *Dhuff_mincode, int *Dhuff_valptr)
{
    ...
    19b4:	afb00014 	sw	s0,20(sp)
    19b8:	00c08021 	addu	s0,a2,zero
    19bc:	afb50028 	sw	s5,40(sp)
    19c0:	afb2001c 	sw	s2,28(sp)
    19c4:	afb10018 	sw	s1,24(sp)
    19c8:	afbf002c 	sw	ra,44(sp)
    19cc:	afb40024 	sw	s4,36(sp)
    19d0:	afb30020 	sw	s3,32(sp)
    19d4:	00808821 	addu	s1,a0,zero
    19d8:	00a09021 	addu	s2,a1,zero
  int code, l, p;

  code = buf_getb ();
    19dc:	0c000000 	jal	0 <pgetc>
    19e0:	00e0a821 	addu	s5,a3,zero
  for (l = 1; code > Dhuff_maxcode[l]; l++)
    19e4:	8e030004 	lw	v1,4(s0)
    19e8:	00000000 	sll	zero,zero,0x0
    19ec:	0062182a 	slt	v1,v1,v0
    19f0:	10600026 	beqz	v1,1a8c <DecodeHuffman+0xdc>
    19f4:	00000000 	sll	zero,zero,0x0
    19f8:	08000681 	j	1a04 <DecodeHuffman+0x54>
    19fc:	24130008 	addiu	s3,zero,8
    1a00:	00809821 	addu	s3,a0,zero
    {
      code = (code << 1) + buf_getb ();
    1a04:	0c000000 	jal	0 <pgetc>
    1a08:	0002a040 	sll	s4,v0,0x1
	       ...
	       int *Dhuff_maxcode, int *Dhuff_mincode, int *Dhuff_valptr)
{
  ...
  code = buf_getb ();
  for (l = 1; code > Dhuff_maxcode[l]; l++)
    1a10:	8c630000 	lw	v1,0(v1)
    {
      code = (code << 1) + buf_getb ();
    1a14:	02821021 	addu	v0,s4,v0
	       int *Dhuff_maxcode, int *Dhuff_mincode, int *Dhuff_valptr)
{
  int code, l, p;
  ...
  code = buf_getb ();
  for (l = 1; code > Dhuff_maxcode[l]; l++)
    1a18:	0062182a 	slt	v1,v1,v0
    1a1c:	1460fff8 	bnez	v1,1a00 <DecodeHuffman+0x50>
    1a20:	26640004 	addiu	a0,s3,4
    {
      code = (code << 1) + buf_getb ();
    }

  if (code < Dhuff_maxcode[Dhuff_ml])
    1a24:	00129080 	sll	s2,s2,0x2
    1a28:	02128021 	addu	s0,s0,s2
    1a2c:	8e030000 	lw	v1,0(s0)
    1a30:	00000000 	sll	zero,zero,0x0
    1a34:	0043182a 	slt	v1,v0,v1
    1a38:	10600016 	beqz	v1,1a94 <DecodeHuffman+0xe4>
    1a3c:	00000000 	sll	zero,zero,0x0
    {
      p = Dhuff_valptr[l] + code - Dhuff_mincode[l];
    1a40:	8fa30040 	lw	v1,64(sp)
      main_result++;
  ...
  if (code < Dhuff_maxcode[Dhuff_ml])
    {
      p = Dhuff_valptr[l] + code - Dhuff_mincode[l];
    1a48:	00731821 	addu	v1,v1,s3
    1a4c:	8c740000 	lw	s4,0(v1)
    1a50:	02b39821 	addu	s3,s5,s3
    1a54:	8e630000 	lw	v1,0(s3)
    1a58:	00541021 	addu	v0,v0,s4
    1a5c:	00431023 	subu	v0,v0,v1
      return (Xhuff_huffval[p]);
    1a60:	00021080 	sll	v0,v0,0x2
    1a64:	02228821 	addu	s1,s1,v0
      main_result++;
      printf ("Huffman read error\n");
      EXIT;
    }
    ...
    1a68:	8e220000 	lw	v0,0(s1)
    1a6c:	8fb50028 	lw	s5,40(sp)
    1a70:	8fb40024 	lw	s4,36(sp)
    1a74:	8fb30020 	lw	s3,32(sp)
    1a78:	8fb2001c 	lw	s2,28(sp)
    1a7c:	8fb10018 	lw	s1,24(sp)
    1a80:	8fb00014 	lw	s0,20(sp)
    1a84:	03e00008 	jr	ra
    1a88:	27bd0030 	addiu	sp,sp,48
	       int *Dhuff_maxcode, int *Dhuff_mincode, int *Dhuff_valptr)
{
  int code, l, p;
  ...
  code = buf_getb ();
  for (l = 1; code > Dhuff_maxcode[l]; l++)
    1a8c:	08000689 	j	1a24 <DecodeHuffman+0x74>
    1a90:	24130004 	addiu	s3,zero,4
      p = Dhuff_valptr[l] + code - Dhuff_mincode[l];
      return (Xhuff_huffval[p]);
    }
  else
    ...
    {
      main_result++;
    1a9c:	24420001 	addiu	v0,v0,1
      printf ("Huffman read error\n");
    1aa0:	24840000 	addiu	a0,a0,0
    1aa4:	0c000000 	jal	0 <pgetc>
    1aa8:	af820000 	sw	v0,0(gp)
      EXIT;
    1aac:	0c000000 	jal	0 <pgetc>
    1ab0:	00002021 	addu	a0,zero,zero

00001ab4 <DecodeHuffMCU>:
/*
 * Decode one MCU
 */
void
...
DecodeHuffMCU (int *out_buf, int num_cmp)
{
    1abc:	afb40038 	sw	s4,56(sp)
    1ac0:	afb30034 	sw	s3,52(sp)
    1ac4:	afb20030 	sw	s2,48(sp)
    1ac8:	afb1002c 	sw	s1,44(sp)
    1acc:	afb00028 	sw	s0,40(sp)
    1ad0:	afbf004c 	sw	ra,76(sp)
    1ad4:	afbe0048 	sw	s8,72(sp)
    1ad8:	afb70044 	sw	s7,68(sp)
    1adc:	afb60040 	sw	s6,64(sp)
    1ae0:	afb5003c 	sw	s5,60(sp)
  int s, diff, tbl_no, *mptr, k, n, r;
   ...
   */
  tbl_no = p_jinfo_comps_info_dc_tbl_no[num_cmp];
    1ae4:	00451021 	addu	v0,v0,a1
    1ae8:	80420000 	lb	v0,0(v0)
  s = DecodeHuffman (&p_jinfo_dc_xhuff_tbl_huffval[tbl_no][0],
    1aec:	27830000 	addiu	v1,gp,0
    1af0:	00029080 	sll	s2,v0,0x2
    1af4:	00029a80 	sll	s3,v0,0xa
		     p_jinfo_dc_dhuff_tbl_ml[tbl_no],
		     &p_jinfo_dc_dhuff_tbl_maxcode[tbl_no][0],
    1af8:	00028100 	sll	s0,v0,0x4
    1afc:	000211c0 	sll	v0,v0,0x7
    1b00:	02028021 	addu	s0,s0,v0
  ...
  tbl_no = p_jinfo_comps_info_dc_tbl_no[num_cmp];
  s = DecodeHuffman (&p_jinfo_dc_xhuff_tbl_huffval[tbl_no][0],
    1b04:	00721821 	addu	v1,v1,s2
    1b08:	3c020000 	lui	v0,0x0
/*
 * Decode one MCU
 */
void
DecodeHuffMCU (int *out_buf, int num_cmp)
{
  ...
  tbl_no = p_jinfo_comps_info_dc_tbl_no[num_cmp];
  s = DecodeHuffman (&p_jinfo_dc_xhuff_tbl_huffval[tbl_no][0],
    1b10:	3c060000 	lui	a2,0x0
    1b14:	3c040000 	lui	a0,0x0
    1b18:	3c070000 	lui	a3,0x0
    1b1c:	8c650000 	lw	a1,0(v1)
    1b20:	02539821 	addu	s3,s2,s3
    1b24:	24420000 	addiu	v0,v0,0
    1b28:	24840000 	addiu	a0,a0,0
    1b2c:	24c60000 	addiu	a2,a2,0
    1b30:	24e70000 	addiu	a3,a3,0
    1b34:	00501021 	addu	v0,v0,s0
    1b38:	00932021 	addu	a0,a0,s3
    1b3c:	00d03021 	addu	a2,a2,s0
    1b40:	00f03821 	addu	a3,a3,s0
    1b44:	0c000000 	jal	0 <pgetc>
    1b48:	afa20010 	sw	v0,16(sp)
		     p_jinfo_dc_dhuff_tbl_ml[tbl_no],
		     &p_jinfo_dc_dhuff_tbl_maxcode[tbl_no][0],
  ...
  if (s)
    1b4c:	14400053 	bnez	v0,1c9c <DecodeHuffMCU+0x1e8>
    1b50:	0040a021 	addu	s4,v0,zero
...
DecodeHuffMCU (int *out_buf, int num_cmp)
  ...
  /* Set all values to zero */
  for (mptr = out_buf + 1; mptr < out_buf + DCTSIZE2; mptr++)
    1b60:	24420004 	addiu	v0,v0,4
    1b64:	1443fffd 	bne	v0,v1,1b5c <DecodeHuffMCU+0xa8>
    ...
    1b6c:	26d60000 	addiu	s6,s6,0
    1b70:	02d3b021 	addu	s6,s6,s3
    1b74:	3c150000 	lui	s5,0x0
    1b78:	3c140000 	lui	s4,0x0
    1b7c:	3c130000 	lui	s3,0x0
    1b80:	26b50000 	addiu	s5,s5,0
    1b84:	26940000 	addiu	s4,s4,0
    1b88:	26730000 	addiu	s3,s3,0
      *mptr = 0;
    }
  ...
  for (k = 1; k < DCTSIZE2;)
    ...
    1b94:	02b0a821 	addu	s5,s5,s0
    1b98:	0290a021 	addu	s4,s4,s0
    1b9c:	02709821 	addu	s3,s3,s0
      *mptr = 0;
    }
  ...
  for (mptr = out_buf + 1; mptr < out_buf + DCTSIZE2; mptr++)
    ...
    1ba8:	2417000f 	addiu	s7,zero,15
	    break;
	  out_buf[k] = buf_getv (s);	/* Get s bits */
	  s--;			/* Align s */
	  if ((out_buf[k] & bit_set_mask[s]) == 0)
	    {			/* Also (1 << s) */
	      out_buf[k] |= extend_mask[s];	/* Also  (-1 << s) + 1 */
    1bac:	27de56bc 	addiu	s8,s8,22204
      *mptr = 0;
    }
  ...
  for (k = 1; k < DCTSIZE2;)
    {				/* JPEG Mistake */
      r = DecodeHuffman (&p_jinfo_ac_xhuff_tbl_huffval[tbl_no][0],
    1bb0:	8e450000 	lw	a1,0(s2)
    1bb4:	02c02021 	addu	a0,s6,zero
    1bb8:	02a03021 	addu	a2,s5,zero
    1bbc:	02803821 	addu	a3,s4,zero
    1bc0:	0c000000 	jal	0 <pgetc>
    1bc4:	afb30010 	sw	s3,16(sp)
    ...
    1bc8:	3045000f 	andi	a1,v0,0xf
      n = (r >> 4) & 0xf;	/* n = run-length */
    1bcc:	00021103 	sra	v0,v0,0x4
    1bd0:	3042000f 	andi	v0,v0,0xf

      if (s)
	{
	  if ((k += n) >= DCTSIZE2)	/* JPEG Mistake */
    1bd4:	00501821 	addu	v1,v0,s0
	    break;
	  out_buf[k] = buf_getv (s);	/* Get s bits */
    1bd8:	00033080 	sll	a2,v1,0x2
    1bdc:	00a02021 	addu	a0,a1,zero
    1be0:	02263021 	addu	a2,s1,a2
			 &p_jinfo_ac_dhuff_tbl_valptr[tbl_no][0]);
      ...
      if (s)
    1be4:	10a00029 	beqz	a1,1c8c <DecodeHuffMCU+0x1d8>
    1be8:	28670040 	slti	a3,v1,64
	{
	  if ((k += n) >= DCTSIZE2)	/* JPEG Mistake */
    1bec:	10e0001b 	beqz	a3,1c5c <DecodeHuffMCU+0x1a8>
    1bf0:	00000000 	sll	zero,zero,0x0
	    break;
	  out_buf[k] = buf_getv (s);	/* Get s bits */
    1bf4:	afa3001c 	sw	v1,28(sp)
    1bf8:	afa50018 	sw	a1,24(sp)
    1bfc:	0c000000 	jal	0 <pgetc>
    1c00:	afa60020 	sw	a2,32(sp)
	  s--;			/* Align s */
    1c04:	8fa50018 	lw	a1,24(sp)
	  if ((out_buf[k] & bit_set_mask[s]) == 0)
    1c08:	3c040000 	lui	a0,0x0
      if (s)
	{
	  if ((k += n) >= DCTSIZE2)	/* JPEG Mistake */
	    break;
	  out_buf[k] = buf_getv (s);	/* Get s bits */
	  s--;			/* Align s */
    1c0c:	24a5ffff 	addiu	a1,a1,-1
	  if ((out_buf[k] & bit_set_mask[s]) == 0)
    1c10:	00052880 	sll	a1,a1,0x2
    1c14:	24840000 	addiu	a0,a0,0
	    {			/* Also (1 << s) */
	      out_buf[k] |= extend_mask[s];	/* Also  (-1 << s) + 1 */
    1c18:	00be3821 	addu	a3,a1,s8
	{
	  if ((k += n) >= DCTSIZE2)	/* JPEG Mistake */
	    break;
	  out_buf[k] = buf_getv (s);	/* Get s bits */
	  s--;			/* Align s */
	  if ((out_buf[k] & bit_set_mask[s]) == 0)
    1c1c:	00a42821 	addu	a1,a1,a0
    1c20:	8ca40000 	lw	a0,0(a1)
      ...
      if (s)
	{
	  if ((k += n) >= DCTSIZE2)	/* JPEG Mistake */
	    break;
	  out_buf[k] = buf_getv (s);	/* Get s bits */
    1c24:	8fa60020 	lw	a2,32(sp)
	  s--;			/* Align s */
	  if ((out_buf[k] & bit_set_mask[s]) == 0)
    1c28:	00442024 	and	a0,v0,a0
      ...
      if (s)
	{
	  if ((k += n) >= DCTSIZE2)	/* JPEG Mistake */
	    break;
	  out_buf[k] = buf_getv (s);	/* Get s bits */
    1c2c:	acc20000 	sw	v0,0(a2)
	  s--;			/* Align s */
	  if ((out_buf[k] & bit_set_mask[s]) == 0)
    1c30:	8fa3001c 	lw	v1,28(sp)
    1c34:	14800006 	bnez	a0,1c50 <DecodeHuffMCU+0x19c>
    1c38:	24700001 	addiu	s0,v1,1
	    {			/* Also (1 << s) */
	      out_buf[k] |= extend_mask[s];	/* Also  (-1 << s) + 1 */
    1c3c:	8ce40000 	lw	a0,0(a3)
    1c40:	00000000 	sll	zero,zero,0x0
    1c44:	00441025 	or	v0,v0,a0
	      out_buf[k]++;	/* Increment 2's c */
    1c48:	24420001 	addiu	v0,v0,1
    1c4c:	acc20000 	sw	v0,0(a2)
  for (mptr = out_buf + 1; mptr < out_buf + DCTSIZE2; mptr++)
    {
      *mptr = 0;
    }
  ...
  for (k = 1; k < DCTSIZE2;)
    1c50:	2a020040 	slti	v0,s0,64
    1c54:	1440ffd6 	bnez	v0,1bb0 <DecodeHuffMCU+0xfc>
    ...
    1c5c:	8fbf004c 	lw	ra,76(sp)
    1c60:	8fbe0048 	lw	s8,72(sp)
    1c64:	8fb70044 	lw	s7,68(sp)
    1c68:	8fb60040 	lw	s6,64(sp)
    1c6c:	8fb5003c 	lw	s5,60(sp)
    1c70:	8fb40038 	lw	s4,56(sp)
    1c74:	8fb30034 	lw	s3,52(sp)
    1c78:	8fb20030 	lw	s2,48(sp)
    1c7c:	8fb1002c 	lw	s1,44(sp)
    1c80:	8fb00028 	lw	s0,40(sp)
    1c84:	03e00008 	jr	ra
    1c88:	27bd0050 	addiu	sp,sp,80
	      out_buf[k] |= extend_mask[s];	/* Also  (-1 << s) + 1 */
	      out_buf[k]++;	/* Increment 2's c */
	    }
	  k++;			/* Goto next element */
    ...
    1c8c:	1457fff3 	bne	v0,s7,1c5c <DecodeHuffMCU+0x1a8>
    1c90:	26100010 	addiu	s0,s0,16
  for (mptr = out_buf + 1; mptr < out_buf + DCTSIZE2; mptr++)
    {
      *mptr = 0;
    }
  ...
  for (k = 1; k < DCTSIZE2;)
    1c94:	08000715 	j	1c54 <DecodeHuffMCU+0x1a0>
    1c98:	2a020040 	slti	v0,s0,64
		     &p_jinfo_dc_dhuff_tbl_mincode[tbl_no][0],
		     &p_jinfo_dc_dhuff_tbl_valptr[tbl_no][0]);
  ...
  if (s)
    {
      diff = buf_getv (s);
    1c9c:	0c000000 	jal	0 <pgetc>
    1ca0:	00402021 	addu	a0,v0,zero
      s--;
    1ca4:	2694ffff 	addiu	s4,s4,-1
      if ((diff & bit_set_mask[s]) == 0)
    1ca8:	3c030000 	lui	v1,0x0
    1cac:	0014a080 	sll	s4,s4,0x2
    1cb0:	24630000 	addiu	v1,v1,0
    1cb4:	02831821 	addu	v1,s4,v1
    1cb8:	8c630000 	lw	v1,0(v1)
    1cbc:	00000000 	sll	zero,zero,0x0
    1cc0:	00431824 	and	v1,v0,v1
    1cc4:	14600007 	bnez	v1,1ce4 <DecodeHuffMCU+0x230>
    1cc8:	3c030000 	lui	v1,0x0
	{
	  diff |= extend_mask[s];
    1ccc:	246356bc 	addiu	v1,v1,22204
    1cd0:	0283a021 	addu	s4,s4,v1
    1cd4:	8e830000 	lw	v1,0(s4)
    1cd8:	00000000 	sll	zero,zero,0x0
    1cdc:	00431025 	or	v0,v0,v1
	  diff++;
    1ce0:	24420001 	addiu	v0,v0,1
	}

      diff += *out_buf;		/* Change the last DC */
    1ce4:	8e230000 	lw	v1,0(s1)
    1ce8:	00000000 	sll	zero,zero,0x0
    1cec:	00621021 	addu	v0,v1,v0
      *out_buf = diff;
    1cf0:	080006d5 	j	1b54 <DecodeHuffMCU+0xa0>
    1cf4:	ae220000 	sw	v0,0(s1)

00001cf8 <decode_block>:
/*
 * Decode one block
 */
void
...
{
    1cf8:	27bdfed8 	addiu	sp,sp,-296
    1cfc:	afb0011c 	sw	s0,284(sp)
    1d00:	00808021 	addu	s0,a0,zero
    1d04:	afb10120 	sw	s1,288(sp)
  int QuantBuff[DCTSIZE2];
  unsigned int *p_quant_tbl;

  DecodeHuffMCU (HuffBuff, comp_no);
    1d08:	00c02021 	addu	a0,a2,zero
/*
 * Decode one block
 */
void
decode_block (int comp_no, int *out_buf, int *HuffBuff)
{
    1d0c:	00a08821 	addu	s1,a1,zero
  int QuantBuff[DCTSIZE2];
  unsigned int *p_quant_tbl;

  DecodeHuffMCU (HuffBuff, comp_no);
    1d10:	afa60110 	sw	a2,272(sp)
/*
 * Decode one block
 */
void
decode_block (int comp_no, int *out_buf, int *HuffBuff)
{
    1d14:	afbf0124 	sw	ra,292(sp)
  int QuantBuff[DCTSIZE2];
  unsigned int *p_quant_tbl;

  DecodeHuffMCU (HuffBuff, comp_no);
    1d18:	0c000000 	jal	0 <pgetc>
    1d1c:	02002821 	addu	a1,s0,zero
    1d20:	3c080000 	lui	t0,0x0
void
IZigzagMatrix (int *imatrix, int *omatrix)
{
  int i;
...
decode_block (int comp_no, int *out_buf, int *HuffBuff)
{
  ...
  DecodeHuffMCU (HuffBuff, comp_no);
    1d28:	00001021 	addu	v0,zero,zero
    1d2c:	27a40010 	addiu	a0,sp,16
    1d30:	25080000 	addiu	t0,t0,0
void
IZigzagMatrix (int *imatrix, int *omatrix)
{
  int i;
  ...
  for (i = 0; i < DCTSIZE2; i++)
    1d34:	24070100 	addiu	a3,zero,256
...
*(omatrix++) = imatrix[zigzag_index[i]];
    1d44:	00052880 	sll	a1,a1,0x2
    1d48:	00c52821 	addu	a1,a2,a1
    1d4c:	8ca50000 	lw	a1,0(a1)
    1d50:	24420004 	addiu	v0,v0,4
void
IZigzagMatrix (int *imatrix, int *omatrix)
{
  int i;
  ...
  for (i = 0; i < DCTSIZE2; i++)
    1d54:	1447fff8 	bne	v0,a3,1d38 <decode_block+0x40>
    1d58:	ac650000 	sw	a1,0(v1)
  DecodeHuffMCU (HuffBuff, comp_no);
  ...
  p_quant_tbl =
    ...
    1d5c:	27820000 	addiu	v0,gp,0
    1d60:	00508021 	addu	s0,v0,s0
    1d64:	82020000 	lb	v0,0(s0)
  ...
  p_quant_tbl =
    1d68:	3c030000 	lui	v1,0x0
    &p_jinfo_quant_tbl_quantval[(int)p_jinfo_comps_info_quant_tbl_no[comp_no]][DCTSIZE2];
    1d6c:	24420001 	addiu	v0,v0,1
    1d70:	00021200 	sll	v0,v0,0x8
  ...
  p_quant_tbl =
    1d74:	24630000 	addiu	v1,v1,0
    1d78:	00621821 	addu	v1,v1,v0
...
IQuantize (int *matrix, int *qmatrix)
{
  ...
  for (mptr = matrix; mptr < matrix + DCTSIZE2; mptr++)
    1d80:	00801021 	addu	v0,a0,zero
    {
      *mptr = *mptr * (*qmatrix);
    1d84:	8c660000 	lw	a2,0(v1)
    1d88:	8c470000 	lw	a3,0(v0)
    1d8c:	00000000 	sll	zero,zero,0x0
    1d90:	00e60018 	mult	a3,a2
    1d94:	00003012 	mflo	a2
    1d98:	ac460000 	sw	a2,0(v0)
void
IQuantize (int *matrix, int *qmatrix)
{
  int *mptr;
  ...
  for (mptr = matrix; mptr < matrix + DCTSIZE2; mptr++)
    1d9c:	24420004 	addiu	v0,v0,4
    1da0:	1445fff8 	bne	v0,a1,1d84 <decode_block+0x8c>
    1da4:	24630004 	addiu	v1,v1,4
  ...
  ChenIDct (QuantBuff, out_buf);
    1da8:	0c000000 	jal	0 <pgetc>
    1dac:	02202821 	addu	a1,s1,zero
 */
void
PostshiftIDctMatrix (int *matrix, int shift)
{
  ...
  ChenIDct (QuantBuff, out_buf);
    1db4:	24030040 	addiu	v1,zero,64
PostshiftIDctMatrix (int *matrix, int shift)
{
  int *mptr;
  for (mptr = matrix; mptr < matrix + DCTSIZE2; mptr++)
...
PostshiftIDctMatrix (int *matrix, int shift)
{
  int *mptr;
  for (mptr = matrix; mptr < matrix + DCTSIZE2; mptr++)
    1dbc:	2463ffff 	addiu	v1,v1,-1
    {
      *mptr += shift;
    1dc0:	24840080 	addiu	a0,a0,128
    1dc4:	ac440000 	sw	a0,0(v0)
 */
void
PostshiftIDctMatrix (int *matrix, int shift)
{
  int *mptr;
  for (mptr = matrix; mptr < matrix + DCTSIZE2; mptr++)
    1dc8:	1460fffb 	bnez	v1,1db8 <decode_block+0xc0>
  ...
  BoundIDctMatrix (out_buf, IDCT_BOUNT);
    1dd0:	02202021 	addu	a0,s1,zero
    1dd4:	0c000000 	jal	0 <pgetc>
    1dd8:	240500ff 	addiu	a1,zero,255

}
    1ddc:	8fbf0124 	lw	ra,292(sp)
    1de0:	8fb10120 	lw	s1,288(sp)
    1de4:	8fb0011c 	lw	s0,284(sp)
    1de8:	03e00008 	jr	ra
    1dec:	27bd0128 	addiu	sp,sp,296

00001df0 <decode_start>:
...
{
    1df0:	27bdf6a8 	addiu	sp,sp,-2392
    1df4:	afb00930 	sw	s0,2352(sp)
...
decode_start (int *out_data_image_width, int *out_data_image_height,
	      int *out_data_comp_vpos, int *out_data_comp_hpos)
{
    1e08:	afb10934 	sw	s1,2356(sp)
    1e0c:	afbf0954 	sw	ra,2388(sp)
    1e10:	afbe0950 	sw	s8,2384(sp)
    1e14:	afb7094c 	sw	s7,2380(sp)
    1e18:	afb60948 	sw	s6,2376(sp)
    1e1c:	afb50944 	sw	s5,2372(sp)
    1e20:	afb40940 	sw	s4,2368(sp)
    1e24:	afb3093c 	sw	s3,2364(sp)
    1e28:	afb20938 	sw	s2,2360(sp)
  int CurrentMCU = 0;
  int HuffBuff[NUM_COMPONENT][DCTSIZE2];
  int IDCTBuff[6][DCTSIZE2];
  ...
  for (i = 0; i < NUM_COMPONENT; i++)
    {
      HuffBuff[i][0] = 0;
    1e30:	afa00020 	sw	zero,32(sp)
    1e34:	afa00120 	sw	zero,288(sp)
    1e38:	afa00220 	sw	zero,544(sp)
    }
   ...
   */
  *out_data_image_width = p_jinfo_image_width;
    1e3c:	ac830000 	sw	v1,0(a0)
  *out_data_image_height = p_jinfo_image_height;
    1e40:	aca20000 	sw	v0,0(a1)
  /*
  ...
  for (i = 0; i < RGB_NUM; i++)
    ...
    1e44:	ae000000 	sw	zero,0(s0)
      out_data_comp_hpos[i] = 0;
    1e48:	ace00000 	sw	zero,0(a3)
  /*
   * Initialize output buffer
   */
  for (i = 0; i < RGB_NUM; i++)
    {
      out_data_comp_vpos[i] = 0;
    1e4c:	ae000004 	sw	zero,4(s0)
      out_data_comp_hpos[i] = 0;
    1e50:	ace00004 	sw	zero,4(a3)
  /*
   * Initialize output buffer
   */
  for (i = 0; i < RGB_NUM; i++)
    {
      out_data_comp_vpos[i] = 0;
    1e54:	ae000008 	sw	zero,8(s0)
      out_data_comp_hpos[i] = 0;
    1e58:	ace00008 	sw	zero,8(a3)
    }


  if (p_jinfo_smp_fact == SF1_1_1)
    1e5c:	8f820000 	lw	v0,0(gp)
    1e60:	00000000 	sll	zero,zero,0x0
    1e64:	14400043 	bnez	v0,1f74 <decode_start+0x184>
    1e68:	00e08821 	addu	s1,a3,zero
    {
      printf ("Decode 1:1:1 NumMCU = %d\n", p_jinfo_NumMCU);
    1e6c:	8f850000 	lw	a1,0(gp)
    1e70:	3c040000 	lui	a0,0x0
    1e74:	0c000000 	jal	0 <pgetc>
    1e78:	24840000 	addiu	a0,a0,0

      /*
       * 1_1_1
       */
      while (CurrentMCU < p_jinfo_NumMCU)
    1e7c:	8f820000 	lw	v0,0(gp)
    1e80:	00000000 	sll	zero,zero,0x0
    1e84:	1840002f 	blez	v0,1f44 <decode_start+0x154>
    1e88:	3c030000 	lui	v1,0x0
    1e8c:	3c020000 	lui	v0,0x0
    1e90:	24630000 	addiu	v1,v1,0
    1e94:	24420000 	addiu	v0,v0,0
	{

	  for (i = 0; i < NUM_COMPONENT; i++)
	    {
	      decode_block (i, IDCTBuff[i], HuffBuff[i]);
    1e98:	27b60320 	addiu	s6,sp,800
void
decode_start (int *out_data_image_width, int *out_data_image_height,
	      int *out_data_comp_vpos, int *out_data_comp_hpos)
{
  int i;
  int CurrentMCU = 0;
    1e9c:	afa00920 	sw	zero,2336(sp)
    1ea0:	27be0020 	addiu	s8,sp,32
    1ea4:	afa30928 	sw	v1,2344(sp)
    1ea8:	afa20924 	sw	v0,2340(sp)
       * 1_1_1
       */
      while (CurrentMCU < p_jinfo_NumMCU)
	{
    ...
    1eac:	24170003 	addiu	s7,zero,3
	   ...
	   */
	  for (i = 0; i < RGB_NUM; i++)
    1eb0:	2415000c 	addiu	s5,zero,12
...
decode_start (int *out_data_image_width, int *out_data_image_height,
	      int *out_data_comp_vpos, int *out_data_comp_hpos)
{
    1eb4:	00009821 	addu	s3,zero,zero
    1eb8:	00009021 	addu	s2,zero,zero
      while (CurrentMCU < p_jinfo_NumMCU)
	{
	  ...
	  for (i = 0; i < NUM_COMPONENT; i++)
	    {
	      decode_block (i, IDCTBuff[i], HuffBuff[i]);
    1ebc:	02402021 	addu	a0,s2,zero
    1ec0:	02762821 	addu	a1,s3,s6
    1ec4:	03d33021 	addu	a2,s8,s3
    1ec8:	0c000000 	jal	0 <pgetc>
    1ecc:	26520001 	addiu	s2,s2,1
       * 1_1_1
       */
      while (CurrentMCU < p_jinfo_NumMCU)
	{
	  ...
	  for (i = 0; i < NUM_COMPONENT; i++)
    1ed0:	1657fffa 	bne	s2,s7,1ebc <decode_start+0xcc>
    1ed4:	26730100 	addiu	s3,s3,256
	    {
	      decode_block (i, IDCTBuff[i], HuffBuff[i]);
	    }
	  ...
	  YuvToRgb (0, IDCTBuff[0], IDCTBuff[1], IDCTBuff[2]);
    1ed8:	00002021 	addu	a0,zero,zero
    1edc:	02c02821 	addu	a1,s6,zero
    1ee0:	27a60420 	addiu	a2,sp,1056
    1ee4:	0c000000 	jal	0 <pgetc>
    1ee8:	27a70520 	addiu	a3,sp,1312
    1eec:	8fb40928 	lw	s4,2344(sp)
    1ef0:	8fb30924 	lw	s3,2340(sp)
    1ef4:	00009021 	addu	s2,zero,zero
	  /*
	   * Write
	   */
	  for (i = 0; i < RGB_NUM; i++)
    ...
    1ef8:	02802021 	addu	a0,s4,zero
    1efc:	02122821 	addu	a1,s0,s2
    1f00:	02323021 	addu	a2,s1,s2
    1f04:	02603821 	addu	a3,s3,zero
    1f08:	0c000000 	jal	0 <pgetc>
    1f0c:	26520004 	addiu	s2,s2,4
    1f10:	26940100 	addiu	s4,s4,256
	   ...
	   */
	  for (i = 0; i < RGB_NUM; i++)
    1f14:	1655fff8 	bne	s2,s5,1ef8 <decode_start+0x108>
    1f18:	267314be 	addiu	s3,s3,5310
	    {
	      WriteBlock (&rgb_buf[0][i][0],
	  ...
	  CurrentMCU++;
    1f1c:	8fa20920 	lw	v0,2336(sp)
    1f20:	00000000 	sll	zero,zero,0x0
    1f24:	24420001 	addiu	v0,v0,1
    1f28:	afa20920 	sw	v0,2336(sp)
      printf ("Decode 1:1:1 NumMCU = %d\n", p_jinfo_NumMCU);
       ...
       */
      while (CurrentMCU < p_jinfo_NumMCU)
    1f2c:	8fa30920 	lw	v1,2336(sp)
    1f30:	8f820000 	lw	v0,0(gp)
    1f34:	00000000 	sll	zero,zero,0x0
    1f38:	0062102a 	slt	v0,v1,v0
    1f3c:	1440ffde 	bnez	v0,1eb8 <decode_start+0xc8>
    1f40:	00009821 	addu	s3,zero,zero
    ...
    1f44:	8fbf0954 	lw	ra,2388(sp)
    1f48:	8fbe0950 	lw	s8,2384(sp)
    1f4c:	8fb7094c 	lw	s7,2380(sp)
    1f50:	8fb60948 	lw	s6,2376(sp)
    1f54:	8fb50944 	lw	s5,2372(sp)
    1f58:	8fb40940 	lw	s4,2368(sp)
    1f5c:	8fb3093c 	lw	s3,2364(sp)
    1f60:	8fb20938 	lw	s2,2360(sp)
    1f64:	8fb10934 	lw	s1,2356(sp)
    1f68:	8fb00930 	lw	s0,2352(sp)
    1f6c:	03e00008 	jr	ra
    1f70:	27bd0958 	addiu	sp,sp,2392
	}
    ...
    1f74:	8f850000 	lw	a1,0(gp)
    1f78:	3c040000 	lui	a0,0x0
    1f7c:	0c000000 	jal	0 <pgetc>
    1f80:	24840000 	addiu	a0,a0,0
      /*
       * 4_1_1
       */
      while (CurrentMCU < p_jinfo_NumMCU)
    1f84:	8f820000 	lw	v0,0(gp)
    1f88:	00000000 	sll	zero,zero,0x0
    1f8c:	1840ffed 	blez	v0,1f44 <decode_start+0x154>
    1f90:	3c030000 	lui	v1,0x0
    1f94:	3c020000 	lui	v0,0x0
    1f98:	24630000 	addiu	v1,v1,0
    1f9c:	24420000 	addiu	v0,v0,0
    ...
    1fa0:	27b50720 	addiu	s5,sp,1824
    1fa4:	27b70820 	addiu	s7,sp,2080
void
decode_start (int *out_data_image_width, int *out_data_image_height,
	      int *out_data_comp_vpos, int *out_data_comp_hpos)
{
  int i;
  int CurrentMCU = 0;
    1fa8:	afa00920 	sw	zero,2336(sp)
    1fac:	27b60320 	addiu	s6,sp,800
    1fb0:	afa30928 	sw	v1,2344(sp)
    1fb4:	afa20924 	sw	v0,2340(sp)
...
decode_start (int *out_data_image_width, int *out_data_image_height,
    ...
    1fc4:	02402821 	addu	a1,s2,zero
    1fc8:	00002021 	addu	a0,zero,zero
    1fcc:	26520100 	addiu	s2,s2,256
    1fd0:	0c000000 	jal	0 <pgetc>
    1fd4:	27a60020 	addiu	a2,sp,32
	  /*
	   * Decode Y element
	   * Decoding Y, U and V elements should be sequentially conducted for the use of Huffman table
	   */
	  ...
	  for (i = 0; i < 4; i++)
    1fd8:	1655fffb 	bne	s2,s5,1fc8 <decode_start+0x1d8>
    1fdc:	02402821 	addu	a1,s2,zero
	    {
	      decode_block (0, IDCTBuff[i], HuffBuff[0]);
	    }
    ...
    1fe0:	24040001 	addiu	a0,zero,1
    1fe4:	02a02821 	addu	a1,s5,zero
    1fe8:	0c000000 	jal	0 <pgetc>
    1fec:	27a60120 	addiu	a2,sp,288

	  /* Decode V */
	  decode_block (2, IDCTBuff[5], HuffBuff[2]);
    1ff0:	24040002 	addiu	a0,zero,2
    1ff4:	02e02821 	addu	a1,s7,zero
    1ff8:	0c000000 	jal	0 <pgetc>
    1ffc:	27a60220 	addiu	a2,sp,544


	  /* Transform from Yuv into RGB */

	  for (i = 0; i < 4; i++)
    2000:	00009021 	addu	s2,zero,zero
	    {
	      YuvToRgb (i, IDCTBuff[i], IDCTBuff[4], IDCTBuff[5]);
    2004:	02402021 	addu	a0,s2,zero
    2008:	02602821 	addu	a1,s3,zero
    200c:	02a03021 	addu	a2,s5,zero
    2010:	02e03821 	addu	a3,s7,zero
    2014:	0c000000 	jal	0 <pgetc>
    2018:	26520001 	addiu	s2,s2,1
	  decode_block (2, IDCTBuff[5], HuffBuff[2]);
	  ...
	  for (i = 0; i < 4; i++)
    201c:	165efff9 	bne	s2,s8,2004 <decode_start+0x214>
    2020:	26730100 	addiu	s3,s3,256
    2024:	8fb20928 	lw	s2,2344(sp)
    2028:	8fb40924 	lw	s4,2340(sp)
    202c:	00009821 	addu	s3,zero,zero
...
void
decode_start (int *out_data_image_width, int *out_data_image_height,
    2030:	02331021 	addu	v0,s1,s3
    2034:	02131821 	addu	v1,s0,s3
	    }
    ...
    2038:	02402021 	addu	a0,s2,zero
    203c:	26450300 	addiu	a1,s2,768
    2040:	26460600 	addiu	a2,s2,1536
    2044:	26470900 	addiu	a3,s2,2304
    2048:	afb40018 	sw	s4,24(sp)
    204c:	afa20014 	sw	v0,20(sp)
    2050:	afa30010 	sw	v1,16(sp)
    2054:	0c000000 	jal	0 <pgetc>
    2058:	26730004 	addiu	s3,s3,4
	    {
	      YuvToRgb (i, IDCTBuff[i], IDCTBuff[4], IDCTBuff[5]);
	    }
	  ...
	  for (i = 0; i < RGB_NUM; i++)
    205c:	2402000c 	addiu	v0,zero,12
	    {
	      Write4Blocks (&rgb_buf[0][i][0],
    2060:	26520100 	addiu	s2,s2,256
	    {
	      YuvToRgb (i, IDCTBuff[i], IDCTBuff[4], IDCTBuff[5]);
	    }
	  ...
	  for (i = 0; i < RGB_NUM; i++)
    2064:	1662fff2 	bne	s3,v0,2030 <decode_start+0x240>
    2068:	269414be 	addiu	s4,s4,5310
			    &out_data_comp_vpos[i],
			    &out_data_comp_hpos[i], &OutData_comp_buf[i][0]);
	    }
    ...
    2074:	24630004 	addiu	v1,v1,4
    {
       ...
       */
      while (CurrentMCU < p_jinfo_NumMCU)
    2078:	0062102a 	slt	v0,v1,v0
    207c:	1440ffcf 	bnez	v0,1fbc <decode_start+0x1cc>
    2080:	afa30920 	sw	v1,2336(sp)
    2084:	080007d1 	j	1f44 <decode_start+0x154>
    2088:	00000000 	sll	zero,zero,0x0

0000208c <jpeg_init_decompress>:
{
  int tmp;
  /*
   * Get MCU number
...
{
    2090:	27bdffd0 	addiu	sp,sp,-48
  int tmp;
  /*
   * Get MCU number
   */
  p_jinfo_MCUHeight = (p_jinfo_image_height - 1) / 8 + 1;
    2094:	2462ffff 	addiu	v0,v1,-1
/*
 * Initialize after reading markers
 */
void
jpeg_init_decompress ()
{
    2098:	afbf002c 	sw	ra,44(sp)
    209c:	afb30028 	sw	s3,40(sp)
    20a0:	afb20024 	sw	s2,36(sp)
    20a4:	afb10020 	sw	s1,32(sp)
  int tmp;
  /*
   * Get MCU number
   */
  p_jinfo_MCUHeight = (p_jinfo_image_height - 1) / 8 + 1;
    20a8:	04400042 	bltz	v0,21b4 <jpeg_init_decompress+0x128>
    20ac:	afb0001c 	sw	s0,28(sp)
  p_jinfo_MCUWidth = (p_jinfo_image_width - 1) / 8 + 1;
    20b0:	87840000 	lh	a0,0(gp)
{
  int tmp;
  /*
   * Get MCU number
   */
  p_jinfo_MCUHeight = (p_jinfo_image_height - 1) / 8 + 1;
    20b4:	000210c3 	sra	v0,v0,0x3
    20b8:	24430001 	addiu	v1,v0,1
  p_jinfo_MCUWidth = (p_jinfo_image_width - 1) / 8 + 1;
    20bc:	2482ffff 	addiu	v0,a0,-1
    20c0:	04400043 	bltz	v0,21d0 <jpeg_init_decompress+0x144>
    20c4:	af830000 	sw	v1,0(gp)
    20c8:	000210c3 	sra	v0,v0,0x3
    20cc:	24420001 	addiu	v0,v0,1
  p_jinfo_NumMCU = p_jinfo_MCUHeight * p_jinfo_MCUWidth;
    20d0:	00430018 	mult	v0,v1

  /*
   * Create Huffman Table for decoding
   */
  tmp = huff_make_dhuff_tb (&p_jinfo_dc_xhuff_tbl_bits[0][0],
    20d4:	3c130000 	lui	s3,0x0
    20d8:	3c120000 	lui	s2,0x0
    20dc:	3c110000 	lui	s1,0x0
    20e0:	26730000 	addiu	s3,s3,0
    20e4:	26520000 	addiu	s2,s2,0
    20e8:	26310000 	addiu	s1,s1,0
    20ec:	8f850000 	lw	a1,0(gp)
    20f0:	3c100000 	lui	s0,0x0
    20f4:	02602021 	addu	a0,s3,zero
    20f8:	02403021 	addu	a2,s2,zero
    20fc:	02203821 	addu	a3,s1,zero
    2100:	26100000 	addiu	s0,s0,0
  int tmp;
  /*
   * Get MCU number
   */
  p_jinfo_MCUHeight = (p_jinfo_image_height - 1) / 8 + 1;
  p_jinfo_MCUWidth = (p_jinfo_image_width - 1) / 8 + 1;
    2104:	af820000 	sw	v0,0(gp)
  p_jinfo_NumMCU = p_jinfo_MCUHeight * p_jinfo_MCUWidth;
    2108:	00001012 	mflo	v0

  /*
   * Create Huffman Table for decoding
   */
  tmp = huff_make_dhuff_tb (&p_jinfo_dc_xhuff_tbl_bits[0][0],
    210c:	afb00010 	sw	s0,16(sp)
  /*
   * Get MCU number
   */
  p_jinfo_MCUHeight = (p_jinfo_image_height - 1) / 8 + 1;
  p_jinfo_MCUWidth = (p_jinfo_image_width - 1) / 8 + 1;
  p_jinfo_NumMCU = p_jinfo_MCUHeight * p_jinfo_MCUWidth;
    2110:	af820000 	sw	v0,0(gp)

  /*
   * Create Huffman Table for decoding
   */
  tmp = huff_make_dhuff_tb (&p_jinfo_dc_xhuff_tbl_bits[0][0],
    2114:	0c000000 	jal	0 <pgetc>
    2118:	26100090 	addiu	s0,s0,144
  ...
  tmp = huff_make_dhuff_tb (&p_jinfo_dc_xhuff_tbl_bits[1][0],
    211c:	8f850004 	lw	a1,4(gp)
    2120:	26640090 	addiu	a0,s3,144
    2124:	26460090 	addiu	a2,s2,144
    2128:	26270090 	addiu	a3,s1,144
    212c:	afb00010 	sw	s0,16(sp)
  ...
  tmp = huff_make_dhuff_tb (&p_jinfo_ac_xhuff_tbl_bits[0][0],
    2130:	3c120000 	lui	s2,0x0
    2134:	3c110000 	lui	s1,0x0
    2138:	3c100000 	lui	s0,0x0
    213c:	26520000 	addiu	s2,s2,0
    2140:	26310000 	addiu	s1,s1,0
    2144:	26100000 	addiu	s0,s0,0
  tmp = huff_make_dhuff_tb (&p_jinfo_dc_xhuff_tbl_bits[0][0],
			    p_jinfo_dc_dhuff_tbl_ml[0],
			    &p_jinfo_dc_dhuff_tbl_maxcode[0][0],
			    &p_jinfo_dc_dhuff_tbl_mincode[0][0],
			    &p_jinfo_dc_dhuff_tbl_valptr[0][0]);
  p_jinfo_dc_dhuff_tbl_ml[0] = tmp;
    2148:	af820000 	sw	v0,0(gp)
  tmp = huff_make_dhuff_tb (&p_jinfo_dc_xhuff_tbl_bits[1][0],
    214c:	0c000000 	jal	0 <pgetc>
    2150:	3c130000 	lui	s3,0x0
			    p_jinfo_dc_dhuff_tbl_ml[1],
			    &p_jinfo_dc_dhuff_tbl_maxcode[1][0],
			    &p_jinfo_dc_dhuff_tbl_mincode[1][0],
			    &p_jinfo_dc_dhuff_tbl_valptr[1][0]);
  p_jinfo_dc_dhuff_tbl_ml[1] = tmp;
  tmp = huff_make_dhuff_tb (&p_jinfo_ac_xhuff_tbl_bits[0][0],
    2154:	8f850000 	lw	a1,0(gp)
    2158:	02402021 	addu	a0,s2,zero
    215c:	02203021 	addu	a2,s1,zero
    2160:	02003821 	addu	a3,s0,zero
    2164:	26730000 	addiu	s3,s3,0
    2168:	afb30010 	sw	s3,16(sp)
    216c:	0c000000 	jal	0 <pgetc>
    2170:	af820004 	sw	v0,4(gp)
  ...
  tmp = huff_make_dhuff_tb (&p_jinfo_ac_xhuff_tbl_bits[1][0],
    2174:	8f850004 	lw	a1,4(gp)
    2178:	26730090 	addiu	s3,s3,144
    217c:	26440090 	addiu	a0,s2,144
    2180:	26260090 	addiu	a2,s1,144
    2184:	26070090 	addiu	a3,s0,144
    2188:	afb30010 	sw	s3,16(sp)
    218c:	0c000000 	jal	0 <pgetc>
    2190:	af820000 	sw	v0,0(gp)
  ...
  p_jinfo_ac_dhuff_tbl_ml[1] = tmp;
    ...
    2194:	8fbf002c 	lw	ra,44(sp)
    2198:	8fb30028 	lw	s3,40(sp)
    219c:	8fb20024 	lw	s2,36(sp)
    21a0:	8fb10020 	lw	s1,32(sp)
    21a4:	8fb0001c 	lw	s0,28(sp)
  tmp = huff_make_dhuff_tb (&p_jinfo_ac_xhuff_tbl_bits[1][0],
			    p_jinfo_ac_dhuff_tbl_ml[1],
			    &p_jinfo_ac_dhuff_tbl_maxcode[1][0],
			    &p_jinfo_ac_dhuff_tbl_mincode[1][0],
			    &p_jinfo_ac_dhuff_tbl_valptr[1][0]);
  p_jinfo_ac_dhuff_tbl_ml[1] = tmp;
    21a8:	af820004 	sw	v0,4(gp)
}
    21ac:	03e00008 	jr	ra
    21b0:	27bd0030 	addiu	sp,sp,48
{
  int tmp;
  /*
   * Get MCU number
   */
  p_jinfo_MCUHeight = (p_jinfo_image_height - 1) / 8 + 1;
    21b4:	24620006 	addiu	v0,v1,6
  p_jinfo_MCUWidth = (p_jinfo_image_width - 1) / 8 + 1;
    21b8:	87840000 	lh	a0,0(gp)
{
  int tmp;
  /*
   * Get MCU number
   */
  p_jinfo_MCUHeight = (p_jinfo_image_height - 1) / 8 + 1;
    21bc:	000210c3 	sra	v0,v0,0x3
    21c0:	24430001 	addiu	v1,v0,1
  p_jinfo_MCUWidth = (p_jinfo_image_width - 1) / 8 + 1;
    21c4:	2482ffff 	addiu	v0,a0,-1
    21c8:	0441ffbf 	bgez	v0,20c8 <jpeg_init_decompress+0x3c>
    21cc:	af830000 	sw	v1,0(gp)
    21d0:	08000832 	j	20c8 <jpeg_init_decompress+0x3c>
    21d4:	24820006 	addiu	v0,a0,6
...
{
    21d8:	27bdffe8 	addiu	sp,sp,-24
    21dc:	afbf0014 	sw	ra,20(sp)

  /*
   * Read markers
   */
  read_markers (read_buf);
    21e0:	0c000000 	jal	0 <pgetc>
  ...
  decode_start (&OutData_image_width, &OutData_image_height,
    21f0:	3c060000 	lui	a2,0x0
    21f4:	3c070000 	lui	a3,0x0
		&OutData_comp_vpos[0], &OutData_comp_hpos[0]);

}
    21f8:	8fbf0014 	lw	ra,20(sp)
  jpeg_init_decompress ();
   ...
   */
  decode_start (&OutData_image_width, &OutData_image_height,
    21fc:	27840000 	addiu	a0,gp,0
    2200:	27850000 	addiu	a1,gp,0
    2204:	24c60000 	addiu	a2,a2,0
    2208:	24e70000 	addiu	a3,a3,0
    220c:	08000000 	j	0 <pgetc>
    2210:	27bd0018 	addiu	sp,sp,24

00002214 <jpeg2bmp_main>:
 */
...
int
jpeg2bmp_main ()
    2214:	3c040000 	lui	a0,0x0
{
    2218:	27bdffe8 	addiu	sp,sp,-24
 */
unsigned char JpegFileBuf[JPEG_FILE_SIZE];
...
int
jpeg2bmp_main ()
    222c:	24461457 	addiu	a2,v0,5207
  c = JpegFileBuf;
  for (i = 0; i < JPEGSIZE; i++)
    
    {
        ci = hana_jpg[i];
        *c++ = ci;
    2230:	90650000 	lbu	a1,0(v1)
    2234:	00000000 	sll	zero,zero,0x0
    2238:	a0450000 	sb	a1,0(v0)
    223c:	24420001 	addiu	v0,v0,1
  ...
  c = JpegFileBuf;
  for (i = 0; i < JPEGSIZE; i++)
    2240:	1446fffb 	bne	v0,a2,2230 <jpeg2bmp_main+0x1c>
    2244:	24630001 	addiu	v1,v1,1
    {
        ci = hana_jpg[i];
        *c++ = ci;
    }
  ...
  jpeg_read (JpegFileBuf);
    2248:	0c000000 	jal	0 <pgetc>
    224c:	24840000 	addiu	a0,a0,0
    2250:	3c0c0000 	lui	t4,0x0
    2254:	3c0b0000 	lui	t3,0x0
    2258:	8f870000 	lw	a3,0(gp)

  for (i = 0; i < RGB_NUM; i++)
    225c:	00004821 	addu	t1,zero,zero
    2260:	258c0000 	addiu	t4,t4,0
    2264:	256b0000 	addiu	t3,t3,0
    {
      for (j = 0; j < BMP_OUT_SIZE; j++)
    2268:	240814be 	addiu	t0,zero,5310
        *c++ = ci;
    }
...
int
jpeg2bmp_main ()
    2270:	00091980 	sll	v1,t1,0x6
    2274:	00091080 	sll	v0,t1,0x2
    2278:	00621023 	subu	v0,v1,v0
    227c:	00491023 	subu	v0,v0,t1
    2280:	00021880 	sll	v1,v0,0x2
    2284:	00621023 	subu	v0,v1,v0
    2288:	00021900 	sll	v1,v0,0x4
    228c:	00621823 	subu	v1,v1,v0
    2290:	00031840 	sll	v1,v1,0x1
    2294:	01832021 	addu	a0,t4,v1
    2298:	00001021 	addu	v0,zero,zero
    229c:	01631821 	addu	v1,t3,v1
  ...
  for (i = 0; i < RGB_NUM; i++)
    ...
    22a0:	90860000 	lbu	a2,0(a0)
    22a4:	90650000 	lbu	a1,0(v1)
    22a8:	00000000 	sll	zero,zero,0x0
    22ac:	10c50002 	beq	a2,a1,22b8 <jpeg2bmp_main+0xa4>
    22b0:	24420001 	addiu	v0,v0,1
	    {
	      main_result++;
    22b4:	24e70001 	addiu	a3,a3,1
  ...
  for (i = 0; i < RGB_NUM; i++)
    {
      for (j = 0; j < BMP_OUT_SIZE; j++)
    22b8:	24840001 	addiu	a0,a0,1
    22bc:	1448fff8 	bne	v0,t0,22a0 <jpeg2bmp_main+0x8c>
    22c0:	24630001 	addiu	v1,v1,1
        *c++ = ci;
    }
  ...
  for (i = 0; i < RGB_NUM; i++)
    22c4:	25290001 	addiu	t1,t1,1
    22c8:	152affea 	bne	t1,t2,2274 <jpeg2bmp_main+0x60>
    22cc:	00091980 	sll	v1,t1,0x6
	    {
	      main_result++;
	    }
	}
  ...
  if (OutData_image_width != out_width)
    22d0:	8f820000 	lw	v0,0(gp)
    22d4:	8f830000 	lw	v1,0(gp)
    22d8:	00000000 	sll	zero,zero,0x0
    22dc:	10620003 	beq	v1,v0,22ec <jpeg2bmp_main+0xd8>
    22e0:	af870000 	sw	a3,0(gp)
    {
      main_result++;
    22e4:	24e70001 	addiu	a3,a3,1
    22e8:	af870000 	sw	a3,0(gp)
    }
  if (OutData_image_height != out_length)
    22ec:	8f820000 	lw	v0,0(gp)
    22f0:	8f830000 	lw	v1,0(gp)
    22f4:	00000000 	sll	zero,zero,0x0
    22f8:	10620005 	beq	v1,v0,2310 <jpeg2bmp_main+0xfc>
    22fc:	00000000 	sll	zero,zero,0x0
    {
      main_result++;
    2300:	8f820000 	lw	v0,0(gp)
    2304:	00000000 	sll	zero,zero,0x0
    2308:	24420001 	addiu	v0,v0,1
    230c:	af820000 	sw	v0,0(gp)
    }
  return (0);
}
    2310:	8fbf0014 	lw	ra,20(sp)
    2314:	00001021 	addu	v0,zero,zero
    2318:	03e00008 	jr	ra
    231c:	27bd0018 	addiu	sp,sp,24
...
main ()
{
    2320:	27bdffe8 	addiu	sp,sp,-24
    2324:	afbf0014 	sw	ra,20(sp)
  main_result = 0;
  jpeg2bmp_main ();
    2328:	0c000000 	jal	0 <pgetc>
    232c:	af800000 	sw	zero,0(gp)

  printf ("%d\n", main_result);
    2330:	8f850000 	lw	a1,0(gp)
    2334:	3c040000 	lui	a0,0x0
    2338:	0c000000 	jal	0 <pgetc>
    233c:	24840000 	addiu	a0,a0,0

  return main_result;
}
    2340:	8fbf0014 	lw	ra,20(sp)
    2344:	8f820000 	lw	v0,0(gp)
    2348:	03e00008 	jr	ra
